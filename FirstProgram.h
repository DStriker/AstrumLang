...
using __extension_603_i32 = CppAdvance::i32;
#line 607 "FirstProgram.adv"
[[clang::annotate("UserAttr: AllowPostfix")]] inline constexpr auto _operator_bsl_mul_div(__extension_603_i32 const& __this LIFETIMEBOUND)  -> const CppAdvance::i32;
[[clang::annotate("UserAttr: AllowPostfix")]] inline constexpr auto _operator_bsl_mul_div_postfix(__extension_603_i32 & __this)  -> decltype(auto);
#line 610 "FirstProgram.adv"
[[clang::annotate("UserAttr: Commutative")]] inline constexpr auto _operator_bsl_mul_div(__extension_603_i32 const& __this LIFETIMEBOUND, CppAdvance::f32 other)  -> const CppAdvance::f32;
[[clang::annotate("UserAttr: Commutative")]] inline constexpr auto _operator_bsl_mul_div(CppAdvance::f32 other, const __extension_603_i32 & __this)  -> decltype(auto);
#line 604 "FirstProgram.adv"
inline constexpr auto getkm(__extension_603_i32 const& __this ) -> const CppAdvance::i32;

#line 613 "FirstProgram.adv"
using __extension_613_f64 = CppAdvance::f64;
#line 614 "FirstProgram.adv"
inline constexpr auto getkm(__extension_613_f64 const& __this ) -> const CppAdvance::f64;

#line 617 "FirstProgram.adv"
using __extension_617_str = CppAdvance::Str;
#line 618 "FirstProgram.adv"
inline constexpr auto getkm(__extension_617_str const& __this ) -> const CppAdvance::Str;
...
#line 607 "FirstProgram.adv"
inline constexpr auto _operator_bsl_mul_div(__extension_603_i32 const& __this LIFETIMEBOUND)  -> const CppAdvance::i32
{
	#line 607 "FirstProgram.adv"
	ADV_EXPRESSION_BODY(__this / CppAdvance::i32(2)); 
}
inline constexpr auto _operator_bsl_mul_div_postfix(__extension_603_i32 & __this)  -> decltype(auto) { auto copy = __this; ADV_UFCS(_operator_bsl_mul_div)(__this); return copy; }

#line 610 "FirstProgram.adv"
inline constexpr auto _operator_bsl_mul_div(__extension_603_i32 const& __this LIFETIMEBOUND, CppAdvance::f32 other)  -> const CppAdvance::f32
{
	#line 610 "FirstProgram.adv"
	ADV_EXPRESSION_BODY(CppAdvance::f32{__this} * other * CppAdvance::i32(2)); 
}
inline constexpr auto _operator_bsl_mul_div(CppAdvance::f32 other, const __extension_603_i32 & __this)  -> decltype(auto) { return ADV_UFCS(_operator_bsl_mul_div)(__this, other); }
