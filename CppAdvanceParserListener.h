...
public:
  ...
  virtual void enterAssociatedTypeDeclaration(CppAdvanceParser::AssociatedTypeDeclarationContext *ctx) = 0;
  virtual void exitAssociatedTypeDeclaration(CppAdvanceParser::AssociatedTypeDeclarationContext *ctx) = 0;
