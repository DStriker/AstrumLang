...
#define ADV_PROPERTY_SELF __self
		...
		private: static auto __lazy_init_lazyInt() -> CppAdvance::i32;
		#line 9999 "Collections.ast"
		ADV_PROPERTY_GETTER_LAZY(public, , lazyInt, __lazy_init_lazyInt, CppAdvance::i32);
		...
		#line 9999 "Collections.ast"
		private: template<class __IdxT = CppAdvance::f32> struct __IndexerAccessor_157 {
			private:
			Vector3& _parent;
			CppAdvance::i32 _idx;
			 friend class Vector3;
			public:
			FORCE_INLINE __IndexerAccessor_157(Vector3& parent, CppAdvance::i32 idx) : _parent(parent), _idx(idx) {}
			FORCE_INLINE __IndexerAccessor_157(Vector3 const& parent, CppAdvance::i32 idx) : _parent(const_cast<std::remove_cvref_t<decltype(parent)>&>(parent)), _idx(idx) {}
		...
		friend struct __IndexerAccessor_157<CppAdvance::f32>;
		...
		public: inline auto _operator_subscript(CppAdvance::i32 idx)  -> __IndexerAccessor_157<CppAdvance::f32>;
		public: inline auto _operator_subscript(CppAdvance::i32 idx) const  -> const __IndexerAccessor_157<CppAdvance::f32>;
...
namespace System::Application {
	...
	inline constexpr auto TestInt(__extension_427_Next const& __this LIFETIMEBOUND, CppAdvance::i32 j)  -> const CppAdvance::i32;
...
namespace System::Application {
	...
	template<class T> inline auto operator*(__extension_577_T<T> const& __this LIFETIMEBOUND, CppAdvance::In<CppAdvance::f32> f)  -> const CppAdvance::f32;
	#line 582 "Collections.ast"
	template<class T> inline auto PrintInterface(__extension_577_T<T> const& __this LIFETIMEBOUND, CppAdvance::i32 x)  -> const CppAdvance::i32;
	#line 590 "Collections.ast"
	template<class T> inline const CppAdvance::f32 getAt(__extension_577_T<T> const& __this LIFETIMEBOUND, CppAdvance::f32 r, CppAdvance::f32 g, CppAdvance::f32 b);
	#line 590 "Collections.ast"
	template<class T> inline const CppAdvance::f32 _operator_subscript(__extension_577_T<T> const& __this LIFETIMEBOUND, CppAdvance::f32 r, CppAdvance::f32 g, CppAdvance::f32 b) { return getAt(__this, r, g, b); }
	#line 592 "Collections.ast"
	template<class T> inline auto __construct_(CppAdvance::ConstructorProxy<__extension_577_T<T>> __ctordata, CppAdvance::i32 x, CppAdvance::Str txt)  -> decltype(auto);
	#line 597 "Collections.ast"
	template<class T> inline auto __construct_(CppAdvance::ConstructorProxy<__extension_577_T<T>> __ctordata, typename CppAdvance::MemorySpace mem, CppAdvance::i32 x, CppAdvance::Str txt)  -> decltype(auto);
	#line 578 "Collections.ast"
	template<class T> inline auto getAsString(__extension_577_T<T> const& __this ) -> const CppAdvance::Str;
	...
	template<class T> requires(CppAdvance::TypeIs<T, CppAdvance::i32>()) using __extension_611_T = T;
	#line 615 "Collections.ast"
	template<class T> [[clang::annotate("UserAttr: AllowPostfix")]] inline constexpr auto _operator_bsl_mul_div(__extension_611_T<T> const& __this LIFETIMEBOUND)  -> const CppAdvance::i32;
	...
	template<class T> [[clang::annotate("UserAttr: Commutative")]] inline constexpr auto _operator_bsl_mul_div(__extension_611_T<T> const& __this LIFETIMEBOUND, CppAdvance::f32 other)  -> const CppAdvance::f32;
	template<class T> [[clang::annotate("UserAttr: Commutative")]] inline constexpr auto _operator_bsl_mul_div(CppAdvance::f32 other, const __extension_611_T<T> & __this)  -> decltype(auto);
	#line 612 "Collections.ast"
	template<class T> inline constexpr auto getkm(__extension_611_T<T> const& __this ) -> const CppAdvance::i32;
	
	#line 621 "Collections.ast"
	using __extension_621_f64 = CppAdvance::f64;
	#line 622 "Collections.ast"
	inline constexpr auto getkm(__extension_621_f64 const& __this ) -> const CppAdvance::f64;
	
	#line 625 "Collections.ast"
	using __extension_625_str = CppAdvance::Str;
	#line 626 "Collections.ast"
	inline constexpr auto getkm(__extension_625_str const& __this ) -> const CppAdvance::Str;
...
#line 209 "Collections.ast"
	class ADV_NOVTABLE __Class_VectorClass ADV_ABSTRACT : public CppAdvance::ClassParent<BaseClass> {
		...
		private: friend class TestStruct; friend class __Class_TestStruct;
		#line 219 "Collections.ast"
		private: template<class T> friend class TestStruct2; template<class T> friend class __Class_TestStruct2;
		#line 220 "Collections.ast"
		private: friend const CppAdvance::i32 func3(CppAdvance::i32 x);
		#line 212 "Collections.ast"
		public: mutable CppAdvance::f32 x; ADV_CHECK_REF_STRUCT("f32", CppAdvance::f32);
		#line 212 "Collections.ast"
		public: mutable CppAdvance::f32 y; ADV_CHECK_REF_STRUCT("f32", CppAdvance::f32);
		#line 212 "Collections.ast"
...
#line 157 "Collections.ast"
	auto Vector3::_operator_subscript(CppAdvance::i32 idx)  -> __IndexerAccessor_157<CppAdvance::f32>
	{
		return __IndexerAccessor_157<CppAdvance::f32>{ *this, idx };
	}

	#line 157 "Collections.ast"
	auto Vector3::_operator_subscript(CppAdvance::i32 idx)  const  -> const __IndexerAccessor_157<CppAdvance::f32>
	{
		return __IndexerAccessor_157<CppAdvance::f32>{ *this, idx };
	}
...
#line 615 "Collections.ast"
	template<class T> inline constexpr auto _operator_bsl_mul_div(__extension_611_T<T> const& __this LIFETIMEBOUND)  -> const CppAdvance::i32
	{
		#line 615 "Collections.ast"
...
#line 618 "Collections.ast"
	template<class T> inline constexpr auto _operator_bsl_mul_div(__extension_611_T<T> const& __this LIFETIMEBOUND, CppAdvance::f32 other)  -> const CppAdvance::f32
	{
		#line 618 "Collections.ast"
		ADV_EXPRESSION_BODY(CppAdvance::f32{__this} * other * CppAdvance::i32(2)); 
	}
	template<class T> inline constexpr auto _operator_bsl_mul_div(CppAdvance::f32 other, const __extension_611_T<T> & __this)  -> decltype(auto) { return ADV_UFCS(_operator_bsl_mul_div)(__this, other); }
