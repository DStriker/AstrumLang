...
#define ADV_PROPERTY_SELF __self
		...
		#line 9999 "Collections.ast"
		private: template<class __IdxT = CppAdvance::f32> struct __IndexerAccessor_147 {
			private:
			Vector3& _parent;
			CppAdvance::i32 _idx;
			 friend class Vector3;
			public:
			FORCE_INLINE __IndexerAccessor_147(Vector3& parent, CppAdvance::i32 idx) : _parent(parent), _idx(idx) {}
			FORCE_INLINE __IndexerAccessor_147(Vector3 const& parent, CppAdvance::i32 idx) : _parent(const_cast<std::remove_cvref_t<decltype(parent)>&>(parent)), _idx(idx) {}
			...
			template<class Ch> friend FORCE_INLINE decltype(auto) operator<<(std::basic_ostream<Ch>& stream, const __IndexerAccessor_147<__IdxT>& elem) { return stream << elem.__ref(); }
		...
		friend struct __IndexerAccessor_147<CppAdvance::f32>;
		...
		public: inline auto _operator_subscript(CppAdvance::i32 idx)  -> __IndexerAccessor_147<CppAdvance::f32>;
		public: inline auto _operator_subscript(CppAdvance::i32 idx) const  -> const __IndexerAccessor_147<CppAdvance::f32>;
...
namespace System::Application {
	...
	using __extension_417_Next = Next;
	#line 418 "Collections.ast"
	inline constexpr auto TestInt(__extension_417_Next const& __this LIFETIMEBOUND, CppAdvance::i32 j)  -> const CppAdvance::i32;
...
namespace System::Application {
	...
	template<class T> using __extension_567_T = T;
	#line 570 "Collections.ast"
	template<class T> inline auto operator*(__extension_567_T<T> const& __this LIFETIMEBOUND, CppAdvance::In<CppAdvance::f32> f)  -> const CppAdvance::f32;
	#line 572 "Collections.ast"
	template<class T> inline auto PrintInterface(__extension_567_T<T> const& __this LIFETIMEBOUND, CppAdvance::i32 x)  -> const CppAdvance::i32;
	#line 580 "Collections.ast"
	template<class T> inline const CppAdvance::f32 getAt(__extension_567_T<T> const& __this LIFETIMEBOUND, CppAdvance::f32 r, CppAdvance::f32 g, CppAdvance::f32 b);
	#line 580 "Collections.ast"
	template<class T> inline const CppAdvance::f32 _operator_subscript(__extension_567_T<T> const& __this LIFETIMEBOUND, CppAdvance::f32 r, CppAdvance::f32 g, CppAdvance::f32 b) { return getAt(__this, r, g, b); }
	#line 582 "Collections.ast"
	template<class T> inline auto __construct_(CppAdvance::ConstructorProxy<__extension_567_T<T>> __ctordata, CppAdvance::i32 x, CppAdvance::Str txt)  -> decltype(auto);
	#line 587 "Collections.ast"
	template<class T> inline auto __construct_(CppAdvance::ConstructorProxy<__extension_567_T<T>> __ctordata, typename CppAdvance::MemorySpace mem, CppAdvance::i32 x, CppAdvance::Str txt)  -> decltype(auto);
	#line 568 "Collections.ast"
	template<class T> inline auto getAsString(__extension_567_T<T> const& __this ) -> const CppAdvance::Str;
	
	#line 596 "Collections.ast"
	template<class T> using __extension_596_T = T;
	...
	template<class T> requires(CppAdvance::TypeIs<T, CppAdvance::i32>()) using __extension_601_T = T;
	#line 605 "Collections.ast"
	template<class T> [[clang::annotate("UserAttr: AllowPostfix")]] inline constexpr auto _operator_bsl_mul_div(__extension_601_T<T> const& __this LIFETIMEBOUND)  -> const CppAdvance::i32;
	template<class T> [[clang::annotate("UserAttr: AllowPostfix")]] inline constexpr auto _operator_bsl_mul_div_postfix(__extension_601_T<T> & __this)  -> decltype(auto);
	#line 608 "Collections.ast"
	template<class T> [[clang::annotate("UserAttr: Commutative")]] inline constexpr auto _operator_bsl_mul_div(__extension_601_T<T> const& __this LIFETIMEBOUND, CppAdvance::f32 other)  -> const CppAdvance::f32;
	template<class T> [[clang::annotate("UserAttr: Commutative")]] inline constexpr auto _operator_bsl_mul_div(CppAdvance::f32 other, const __extension_601_T<T> & __this)  -> decltype(auto);
	#line 602 "Collections.ast"
	template<class T> inline constexpr auto getkm(__extension_601_T<T> const& __this ) -> const CppAdvance::i32;
	
	#line 611 "Collections.ast"
	using __extension_611_f64 = CppAdvance::f64;
	#line 612 "Collections.ast"
	inline constexpr auto getkm(__extension_611_f64 const& __this ) -> const CppAdvance::f64;
	
	#line 615 "Collections.ast"
	using __extension_615_str = CppAdvance::Str;
	#line 616 "Collections.ast"
	inline constexpr auto getkm(__extension_615_str const& __this ) -> const CppAdvance::Str;
	...
	using __extension_647_Vector3 = Vector3;
	#line 649 "Collections.ast"
	inline auto getNext(__extension_647_Vector3 const& __this LIFETIMEBOUND)  -> const Next;
...
#line 199 "Collections.ast"
	class ADV_NOVTABLE __Class_VectorClass ADV_ABSTRACT : public CppAdvance::ClassParent<BaseClass> {
		...
		#line 208 "Collections.ast"
		private: friend class TestStruct; friend class __Class_TestStruct;
		#line 209 "Collections.ast"
		private: template<class T> friend class TestStruct2; template<class T> friend class __Class_TestStruct2;
		#line 210 "Collections.ast"
		private: friend const CppAdvance::i32 func3(CppAdvance::i32 x);
		#line 202 "Collections.ast"
		public: mutable CppAdvance::f32 x; ADV_CHECK_REF_STRUCT("f32", CppAdvance::f32);
		#line 202 "Collections.ast"
		public: mutable CppAdvance::f32 y; ADV_CHECK_REF_STRUCT("f32", CppAdvance::f32);
		#line 202 "Collections.ast"
...
#line 82 "Collections.ast"
	inline auto func4(CppAdvance::i32 x)  -> const CppAdvance::i32
	{
		...
		{ std::lock_guard __mutex_lock((x));
			{
				#line 84 "Collections.ast"
				print(CppAdvance::Str{u"Critical section"});
			}
		}
...
#line 147 "Collections.ast"
	auto Vector3::_operator_subscript(CppAdvance::i32 idx)  -> __IndexerAccessor_147<CppAdvance::f32>
	{
		return __IndexerAccessor_147<CppAdvance::f32>{ *this, idx };
	}

	#line 147 "Collections.ast"
	auto Vector3::_operator_subscript(CppAdvance::i32 idx)  const  -> const __IndexerAccessor_147<CppAdvance::f32>
	{
		return __IndexerAccessor_147<CppAdvance::f32>{ *this, idx };
	}
...
#line 605 "Collections.ast"
	template<class T> inline constexpr auto _operator_bsl_mul_div(__extension_601_T<T> const& __this LIFETIMEBOUND)  -> const CppAdvance::i32
	{
		#line 605 "Collections.ast"
		ADV_EXPRESSION_BODY(__this / CppAdvance::i32(2)); 
	}
	template<class T> inline constexpr auto _operator_bsl_mul_div_postfix(__extension_601_T<T> & __this)  -> decltype(auto) { auto copy = __this; ADV_UFCS(_operator_bsl_mul_div)(__this); return copy; }
	
#line 608 "Collections.ast"
	template<class T> inline constexpr auto _operator_bsl_mul_div(__extension_601_T<T> const& __this LIFETIMEBOUND, CppAdvance::f32 other)  -> const CppAdvance::f32
	{
		#line 608 "Collections.ast"
		ADV_EXPRESSION_BODY(CppAdvance::f32{__this} * other * CppAdvance::i32(2)); 
	}
	template<class T> inline constexpr auto _operator_bsl_mul_div(CppAdvance::f32 other, const __extension_601_T<T> & __this)  -> decltype(auto) { return ADV_UFCS(_operator_bsl_mul_div)(__this, other); }
