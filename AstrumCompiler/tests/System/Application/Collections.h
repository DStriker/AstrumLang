...
#define ADV_PROPERTY_SELF __self
		...
		#line 142 "Collections.ast"
		public: inline auto operator++()  LIFETIMEBOUND -> __self&;
		public: inline auto operator++(int)  -> Vector3;
		#line 9999 "Collections.ast"
		private: template<class __IdxT = CppAdvance::f32> struct __IndexerAccessor_152 {
			private:
			Vector3& _parent;
			CppAdvance::i32 _idx;
			 friend class Vector3;
			public:
			FORCE_INLINE __IndexerAccessor_152(Vector3& parent, CppAdvance::i32 idx) : _parent(parent), _idx(idx) {}
			FORCE_INLINE __IndexerAccessor_152(Vector3 const& parent, CppAdvance::i32 idx) : _parent(const_cast<std::remove_cvref_t<decltype(parent)>&>(parent)), _idx(idx) {}
			...
			template<class Ch> friend FORCE_INLINE decltype(auto) operator<<(std::basic_ostream<Ch>& stream, const __IndexerAccessor_152<__IdxT>& elem) { return stream << elem.__ref(); }
		...
		friend struct __IndexerAccessor_152<CppAdvance::f32>;
		...
		public: inline auto _operator_subscript(CppAdvance::i32 idx)  -> __IndexerAccessor_152<CppAdvance::f32>;
		public: inline auto _operator_subscript(CppAdvance::i32 idx) const  -> const __IndexerAccessor_152<CppAdvance::f32>;
...
namespace System::Application {
	...
	using __extension_422_Next = Next;
	#line 423 "Collections.ast"
	inline constexpr auto TestInt(__extension_422_Next const& __this LIFETIMEBOUND, CppAdvance::i32 j)  -> const CppAdvance::i32;
...
namespace System::Application {
	...
	template<class T> using __extension_572_T = T;
	#line 575 "Collections.ast"
	template<class T> inline auto operator*(__extension_572_T<T> const& __this LIFETIMEBOUND, CppAdvance::In<CppAdvance::f32> f)  -> const CppAdvance::f32;
	#line 577 "Collections.ast"
	template<class T> inline auto PrintInterface(__extension_572_T<T> const& __this LIFETIMEBOUND, CppAdvance::i32 x)  -> const CppAdvance::i32;
	#line 585 "Collections.ast"
	template<class T> inline const CppAdvance::f32 getAt(__extension_572_T<T> const& __this LIFETIMEBOUND, CppAdvance::f32 r, CppAdvance::f32 g, CppAdvance::f32 b);
	#line 585 "Collections.ast"
	template<class T> inline const CppAdvance::f32 _operator_subscript(__extension_572_T<T> const& __this LIFETIMEBOUND, CppAdvance::f32 r, CppAdvance::f32 g, CppAdvance::f32 b) { return getAt(__this, r, g, b); }
	#line 587 "Collections.ast"
	template<class T> inline auto __construct_(CppAdvance::ConstructorProxy<__extension_572_T<T>> __ctordata, CppAdvance::i32 x, CppAdvance::Str txt)  -> decltype(auto);
	#line 592 "Collections.ast"
	template<class T> inline auto __construct_(CppAdvance::ConstructorProxy<__extension_572_T<T>> __ctordata, typename CppAdvance::MemorySpace mem, CppAdvance::i32 x, CppAdvance::Str txt)  -> decltype(auto);
	#line 573 "Collections.ast"
	template<class T> inline auto getAsString(__extension_572_T<T> const& __this ) -> const CppAdvance::Str;
	
	#line 601 "Collections.ast"
	template<class T> using __extension_601_T = T;
	...
	template<class T> requires(CppAdvance::TypeIs<T, CppAdvance::i32>()) using __extension_606_T = T;
	#line 610 "Collections.ast"
	template<class T> [[clang::annotate("UserAttr: AllowPostfix")]] inline constexpr auto _operator_bsl_mul_div(__extension_606_T<T> const& __this LIFETIMEBOUND)  -> const CppAdvance::i32;
	template<class T> [[clang::annotate("UserAttr: AllowPostfix")]] inline constexpr auto _operator_bsl_mul_div_postfix(__extension_606_T<T> & __this)  -> decltype(auto);
	#line 613 "Collections.ast"
	template<class T> [[clang::annotate("UserAttr: Commutative")]] inline constexpr auto _operator_bsl_mul_div(__extension_606_T<T> const& __this LIFETIMEBOUND, CppAdvance::f32 other)  -> const CppAdvance::f32;
	template<class T> [[clang::annotate("UserAttr: Commutative")]] inline constexpr auto _operator_bsl_mul_div(CppAdvance::f32 other, const __extension_606_T<T> & __this)  -> decltype(auto);
	#line 607 "Collections.ast"
	template<class T> inline constexpr auto getkm(__extension_606_T<T> const& __this ) -> const CppAdvance::i32;
	
	#line 616 "Collections.ast"
	using __extension_616_f64 = CppAdvance::f64;
	#line 617 "Collections.ast"
	inline constexpr auto getkm(__extension_616_f64 const& __this ) -> const CppAdvance::f64;
	
	#line 620 "Collections.ast"
	using __extension_620_str = CppAdvance::Str;
	#line 621 "Collections.ast"
	inline constexpr auto getkm(__extension_620_str const& __this ) -> const CppAdvance::Str;
	...
	#line 652 "Collections.ast"
	using __extension_652_Vector3 = Vector3;
	#line 654 "Collections.ast"
	inline auto getNext(__extension_652_Vector3 const& __this LIFETIMEBOUND)  -> const Next;
...
#line 204 "Collections.ast"
	class ADV_NOVTABLE __Class_VectorClass ADV_ABSTRACT : public CppAdvance::ClassParent<BaseClass> {
		...
		#line 213 "Collections.ast"
		private: friend class TestStruct; friend class __Class_TestStruct;
		#line 214 "Collections.ast"
		private: template<class T> friend class TestStruct2; template<class T> friend class __Class_TestStruct2;
		#line 215 "Collections.ast"
		private: friend const CppAdvance::i32 func3(CppAdvance::i32 x);
...
#line 82 "Collections.ast"
	inline auto func4(CppAdvance::i32 x)  -> const CppAdvance::i32
	{
		...
		auto xyz = co_await asyncFunc();; 
		#line 87 "Collections.ast"
		if (x > CppAdvance::i32(10)) {
			#line 88 "Collections.ast"
			co_return;
		}
		#line 90 "Collections.ast"
		co_yield x + CppAdvance::i32(2);
...
#line 152 "Collections.ast"
	auto Vector3::_operator_subscript(CppAdvance::i32 idx)  -> __IndexerAccessor_152<CppAdvance::f32>
	{
		return __IndexerAccessor_152<CppAdvance::f32>{ *this, idx };
	}

	#line 152 "Collections.ast"
	auto Vector3::_operator_subscript(CppAdvance::i32 idx)  const  -> const __IndexerAccessor_152<CppAdvance::f32>
	{
		return __IndexerAccessor_152<CppAdvance::f32>{ *this, idx };
	}
...
#line 610 "Collections.ast"
	template<class T> inline constexpr auto _operator_bsl_mul_div(__extension_606_T<T> const& __this LIFETIMEBOUND)  -> const CppAdvance::i32
	{
		#line 610 "Collections.ast"
		ADV_EXPRESSION_BODY(__this / CppAdvance::i32(2)); 
	}
	template<class T> inline constexpr auto _operator_bsl_mul_div_postfix(__extension_606_T<T> & __this)  -> decltype(auto) { auto copy = __this; ADV_UFCS(_operator_bsl_mul_div)(__this); return copy; }
	
#line 613 "Collections.ast"
	template<class T> inline constexpr auto _operator_bsl_mul_div(__extension_606_T<T> const& __this LIFETIMEBOUND, CppAdvance::f32 other)  -> const CppAdvance::f32
	{
		#line 613 "Collections.ast"
		ADV_EXPRESSION_BODY(CppAdvance::f32{__this} * other * CppAdvance::i32(2)); 
	}
	template<class T> inline constexpr auto _operator_bsl_mul_div(CppAdvance::f32 other, const __extension_606_T<T> & __this)  -> decltype(auto) { return ADV_UFCS(_operator_bsl_mul_div)(__this, other); }
