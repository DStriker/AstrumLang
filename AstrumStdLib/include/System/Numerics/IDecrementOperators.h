...
namespace System::Numerics {
	...
	template<class __AnyType, class TSelf> concept __HasMethodImplementation_12b915e35d91c999 = requires(typename __AnyType::__class t) { {t.operator--()} -> std::convertible_to<TSelf>; }  || requires(typename __AnyType::__self t) { {operator--(__extensions::__proxy<typename __AnyType::__self>{t})} -> std::convertible_to<TSelf>; } || requires { --std::declval<typename __AnyType::__self&>(); };
	namespace __vtables {
