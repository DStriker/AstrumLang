...
namespace System::Numerics {
	...
	template<class __AnyType> concept __HasMethodImplementation_acffb75bb6826f81 = requires(typename __AnyType::__class t) { {t.TryParse(std::declval<Builtin::Str>())} -> std::convertible_to<Builtin::Nullable<Builtin::OptionalStrongRef<Builtin::ObjectRef>>>; }  || requires(typename __AnyType::__self t) { {TryParse(__extensions::__proxy<typename __AnyType::__self>{t}, std::declval<Builtin::Str>())} -> std::convertible_to<Builtin::Nullable<Builtin::OptionalStrongRef<Builtin::ObjectRef>>>; } || requires { { [] { using namespace __extensions; return TryParse(std::declval<typename __AnyType::__self>(), std::declval<Builtin::Str>()); }() } -> std::convertible_to<Builtin::Nullable<Builtin::OptionalStrongRef<Builtin::ObjectRef>>>; };
	...
	template<class __AnyType> concept __HasMethodImplementation_geta0ee092e9d654ccb = requires(typename __AnyType::__class t) { {t.getAbs()} -> std::convertible_to<Builtin::OptionalStrongRef<Builtin::ObjectRef>>; } || requires(typename __AnyType::__self t) { {getAbs(__extensions::__proxy<typename __AnyType::__self>{t})} -> std::convertible_to<Builtin::OptionalStrongRef<Builtin::ObjectRef>>; };
