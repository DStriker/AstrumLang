...
} namespace __extensions { template<class _TT> struct __static_getAllBitsSet{ static void get() noexcept { } }; } namespace System::Numerics {
#define ADV_STATIC_EXTENSION_DEFINITION_AllBitsSet
	...
	template<class __AnyType> concept __HasMethodImplementation_gete29f7f5bc87b10e8 = requires { __AnyType::__self::AllBitsSet; } || requires { { [] { using namespace __extensions; return __static_getAllBitsSet<typename __AnyType::__self>::get(); }() } -> std::convertible_to<typename __AnyType::__self>; };
