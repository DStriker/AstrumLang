...
namespace System::Numerics {
	...
	template<class __AnyType, class TRight, class TResult> concept __HasMethodImplementation_35a8a53f5c56d306 = requires(typename __AnyType::__class t) { {t.operator*(std::declval<TRight>())} -> std::convertible_to<TResult>; }  || requires(typename __AnyType::__self t) { {operator*(__extensions::__proxy<typename __AnyType::__self>{t}, std::declval<TRight>())} -> std::convertible_to<TResult>; } || requires { std::declval<typename __AnyType::__self&>() *std::declval<TRight>(); };
	namespace __vtables {
...
namespace System::Numerics {
	...
	template<class __AnyType> concept __HasMethodImplementation_adb58ddad04495cd = requires(typename __AnyType::__class t) { {t.operator*(std::declval<typename __AnyType::__self>())} -> std::convertible_to<typename __AnyType::__self>; }  || requires(typename __AnyType::__self t) { {operator*(__extensions::__proxy<typename __AnyType::__self>{t}, std::declval<typename __AnyType::__self>())} -> std::convertible_to<typename __AnyType::__self>; } || requires { std::declval<typename __AnyType::__self&>() *std::declval<typename __AnyType::__self>(); };
	#line 9 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Numerics\\IMultiplyOperators.ast"
	template<class __AnyType> concept __HasMethodImplementation_1d45512b25367680 = requires(typename __AnyType::__class t) { {t.operator*=(std::declval<typename __AnyType::__self>())} -> std::convertible_to<typename __AnyType::__self>; }  || requires(typename __AnyType::__self t) { {operator*=(__extensions::__proxy<typename __AnyType::__self>{t}, std::declval<typename __AnyType::__self>())} -> std::convertible_to<typename __AnyType::__self>; } || requires { std::declval<typename __AnyType::__self&>() *=std::declval<typename __AnyType::__self>(); };
	namespace __vtables {
