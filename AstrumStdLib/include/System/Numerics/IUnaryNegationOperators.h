...
namespace System::Numerics {
	...
	template<class __AnyType, class TResult> concept __HasMethodImplementation_4d001280d480037d = requires(typename __AnyType::__class t) { {t.operator-()} -> std::convertible_to<TResult>; }  || requires(typename __AnyType::__self t) { {operator-(__extensions::__proxy<typename __AnyType::__self>{t})} -> std::convertible_to<TResult>; } || requires { -std::declval<typename __AnyType::__self&>(); };
	namespace __vtables {
...
namespace System::Numerics {
	...
	template<class __AnyType> concept __HasMethodImplementation_a8388e3f3427f04e = requires(typename __AnyType::__class t) { {t.operator-()} -> std::convertible_to<typename __AnyType::__self>; }  || requires(typename __AnyType::__self t) { {operator-(__extensions::__proxy<typename __AnyType::__self>{t})} -> std::convertible_to<typename __AnyType::__self>; } || requires { -std::declval<typename __AnyType::__self&>(); };
	namespace __vtables {
