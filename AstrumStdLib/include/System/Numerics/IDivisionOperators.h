...
namespace System::Numerics {
	...
	template<class __AnyType, class TRight, class TResult> concept __HasMethodImplementation_1a598be8199a9800 = requires(typename __AnyType::__class t) { {t.operator/(std::declval<TRight>())} -> std::convertible_to<TResult>; }  || requires(typename __AnyType::__self t) { {operator/(__extensions::__proxy<typename __AnyType::__self>{t}, std::declval<TRight>())} -> std::convertible_to<TResult>; } || requires { std::declval<typename __AnyType::__self&>() /std::declval<TRight>(); };
	namespace __vtables {
...
namespace System::Numerics {
	...
	template<class __AnyType> concept __HasMethodImplementation_620dbf4702d52a23 = requires(typename __AnyType::__class t) { {t.operator/(std::declval<typename __AnyType::__self>())} -> std::convertible_to<typename __AnyType::DivisibleArithmeticType>; }  || requires(typename __AnyType::__self t) { {operator/(__extensions::__proxy<typename __AnyType::__self>{t}, std::declval<typename __AnyType::__self>())} -> std::convertible_to<typename __AnyType::DivisibleArithmeticType>; } || requires { std::declval<typename __AnyType::__self&>() /std::declval<typename __AnyType::__self>(); };
	#line 12 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Numerics\\IDivisionOperators.ast"
	template<class __AnyType> concept __HasMethodImplementation_0bc1b4f499f801ca = requires(typename __AnyType::__class t) { {t.operator/=(std::declval<typename __AnyType::__self>())} -> std::convertible_to<typename __AnyType::__self>; }  || requires(typename __AnyType::__self t) { {operator/=(__extensions::__proxy<typename __AnyType::__self>{t}, std::declval<typename __AnyType::__self>())} -> std::convertible_to<typename __AnyType::__self>; } || requires { std::declval<typename __AnyType::__self&>() /=std::declval<typename __AnyType::__self>(); };
