...
namespace System::Numerics {
	...
	template<class __AnyType, class TRight, class TResult> concept __HasMethodImplementation_0f83b4b1085dbddf = requires(typename __AnyType::__class t) { {t.operator&(std::declval<TRight>())} -> std::convertible_to<TResult>; }  || requires(typename __AnyType::__self t) { {operator&(__extensions::__proxy<typename __AnyType::__self>{t}, std::declval<TRight>())} -> std::convertible_to<TResult>; } || requires { std::declval<typename __AnyType::__self&>() &std::declval<TRight>(); };
	#line 5 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Numerics\\IBitwiseOperators.ast"
	template<class __AnyType, class TRight, class TResult> concept __HasMethodImplementation_79d39e0b465d190d = requires(typename __AnyType::__class t) { {t.operator|(std::declval<TRight>())} -> std::convertible_to<TResult>; }  || requires(typename __AnyType::__self t) { {operator|(__extensions::__proxy<typename __AnyType::__self>{t}, std::declval<TRight>())} -> std::convertible_to<TResult>; } || requires { std::declval<typename __AnyType::__self&>() |std::declval<TRight>(); };
	#line 6 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Numerics\\IBitwiseOperators.ast"
	template<class __AnyType, class TRight, class TResult> concept __HasMethodImplementation_f183daed81464b97 = requires(typename __AnyType::__class t) { {t.operator^(std::declval<TRight>())} -> std::convertible_to<TResult>; }  || requires(typename __AnyType::__self t) { {operator^(__extensions::__proxy<typename __AnyType::__self>{t}, std::declval<TRight>())} -> std::convertible_to<TResult>; } || requires { std::declval<typename __AnyType::__self&>() ^std::declval<TRight>(); };
...
namespace System::Numerics {
	...
	template<class __AnyType> concept __HasMethodImplementation_ff48234ff2ef088e = requires(typename __AnyType::__class t) { {t.operator|(std::declval<typename __AnyType::__self>())} -> std::convertible_to<typename __AnyType::__self>; }  || requires(typename __AnyType::__self t) { {operator|(__extensions::__proxy<typename __AnyType::__self>{t}, std::declval<typename __AnyType::__self>())} -> std::convertible_to<typename __AnyType::__self>; } || requires { std::declval<typename __AnyType::__self&>() |std::declval<typename __AnyType::__self>(); };
	#line 15 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Numerics\\IBitwiseOperators.ast"
	template<class __AnyType> concept __HasMethodImplementation_abe6996c7fe0b9d5 = requires(typename __AnyType::__class t) { {t.operator|=(std::declval<typename __AnyType::__self>())} -> std::convertible_to<typename __AnyType::__self>; }  || requires(typename __AnyType::__self t) { {operator|=(__extensions::__proxy<typename __AnyType::__self>{t}, std::declval<typename __AnyType::__self>())} -> std::convertible_to<typename __AnyType::__self>; } || requires { std::declval<typename __AnyType::__self&>() |=std::declval<typename __AnyType::__self>(); };
	#line 16 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Numerics\\IBitwiseOperators.ast"
	template<class __AnyType> concept __HasMethodImplementation_d8a5ef24f4bcfa30 = requires(typename __AnyType::__class t) { {t.operator^(std::declval<typename __AnyType::__self>())} -> std::convertible_to<typename __AnyType::__self>; }  || requires(typename __AnyType::__self t) { {operator^(__extensions::__proxy<typename __AnyType::__self>{t}, std::declval<typename __AnyType::__self>())} -> std::convertible_to<typename __AnyType::__self>; } || requires { std::declval<typename __AnyType::__self&>() ^std::declval<typename __AnyType::__self>(); };
	#line 17 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Numerics\\IBitwiseOperators.ast"
	template<class __AnyType> concept __HasMethodImplementation_06afd9e99cdb625b = requires(typename __AnyType::__class t) { {t.operator^=(std::declval<typename __AnyType::__self>())} -> std::convertible_to<typename __AnyType::__self>; }  || requires(typename __AnyType::__self t) { {operator^=(__extensions::__proxy<typename __AnyType::__self>{t}, std::declval<typename __AnyType::__self>())} -> std::convertible_to<typename __AnyType::__self>; } || requires { std::declval<typename __AnyType::__self&>() ^=std::declval<typename __AnyType::__self>(); };
