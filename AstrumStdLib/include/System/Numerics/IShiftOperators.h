...
namespace System::Numerics {
	...
	template<class __AnyType> concept __HasMethodImplementation_a9302f7f567b3aa0 = requires(typename __AnyType::__class t) { {t.operator>>(std::declval<Builtin::i32>())} -> std::convertible_to<typename __AnyType::__self>; }  || requires(typename __AnyType::__self t) { {operator>>(__extensions::__proxy<typename __AnyType::__self>{t}, std::declval<Builtin::i32>())} -> std::convertible_to<typename __AnyType::__self>; } || requires { std::declval<typename __AnyType::__self&>() >>std::declval<Builtin::i32>(); };
	#line 13 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Numerics\\IShiftOperators.ast"
	template<class __AnyType> concept __HasMethodImplementation_ebc0d8112f8dbde5 = requires(typename __AnyType::__class t) { {t.operator>>=(std::declval<Builtin::i32>())} -> std::convertible_to<typename __AnyType::__self>; }  || requires(typename __AnyType::__self t) { {operator>>=(__extensions::__proxy<typename __AnyType::__self>{t}, std::declval<Builtin::i32>())} -> std::convertible_to<typename __AnyType::__self>; } || requires { std::declval<typename __AnyType::__self&>() >>=std::declval<Builtin::i32>(); };
	#line 15 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Numerics\\IShiftOperators.ast"
	template<class __AnyType> concept __HasMethodImplementation_b72a0b65362ec5e8 = requires(typename __AnyType::__class t) { {t.operator<<(std::declval<Builtin::i32>())} -> std::convertible_to<typename __AnyType::__self>; }  || requires(typename __AnyType::__self t) { {operator<<(__extensions::__proxy<typename __AnyType::__self>{t}, std::declval<Builtin::i32>())} -> std::convertible_to<typename __AnyType::__self>; } || requires { std::declval<typename __AnyType::__self&>() <<std::declval<Builtin::i32>(); };
	#line 17 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Numerics\\IShiftOperators.ast"
	template<class __AnyType> concept __HasMethodImplementation_80e3c7915cb7a40d = requires(typename __AnyType::__class t) { {t.operator<<=(std::declval<Builtin::i32>())} -> std::convertible_to<typename __AnyType::__self>; }  || requires(typename __AnyType::__self t) { {operator<<=(__extensions::__proxy<typename __AnyType::__self>{t}, std::declval<Builtin::i32>())} -> std::convertible_to<typename __AnyType::__self>; } || requires { std::declval<typename __AnyType::__self&>() <<=std::declval<Builtin::i32>(); };
