...
#line 282 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Int8.ast"
	auto MaxMagnitude($extension_Int8_258_i8 const& $this LIFETIMEBOUND, $extension_Int8_258_i8 rhs) noexcept -> const typename $extension_Int8_258_i8
	{
		...
		if ((absX <=> Builtin::i32(0)) < 0) {
			...
			absX = UnsafeCast<$extension_Int8_258_i8>(-Builtin::i32{absX});
		...
		if ((absY <=> Builtin::i32(0)) < 0) {
			...
			absY = UnsafeCast<$extension_Int8_258_i8>(-Builtin::i32{absY});
...
#line 313 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Int8.ast"
	auto MinMagnitude($extension_Int8_258_i8 const& $this LIFETIMEBOUND, $extension_Int8_258_i8 rhs) noexcept -> const typename $extension_Int8_258_i8
	{
...
#line 344 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Int8.ast"
	auto Parse($extension_Int8_258_i8 const& $this LIFETIMEBOUND, Builtin::Str input)  -> const typename $extension_Int8_258_i8
	{
...
#line 349 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Int8.ast"
	auto TryParse($extension_Int8_258_i8 const& $this LIFETIMEBOUND, Builtin::Str input) noexcept -> const Builtin::Nullable<$extension_Int8_258_i8>
	{
...
#line 377 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Int8.ast"
	auto CopySign($extension_Int8_374_i8 const& $this LIFETIMEBOUND, $extension_Int8_374_i8 sign)  -> const typename $extension_Int8_374_i8
	{
		...
		if ((absValue <=> Builtin::i32(0)) < 0) {
			...
			absValue = UnsafeCast<$extension_Int8_374_i8>(-Builtin::i32{absValue});
		}
		...
		return UnsafeCast<$extension_Int8_374_i8>(-Builtin::i32{absValue});
	}
	
} namespace System{
} namespace $extensions { using namespace System;
#line 487 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Int8.ast"
	auto Log($extension_Int8_402_i8 const& $this LIFETIMEBOUND, $extension_Int8_402_i8 base)  -> const typename $extension_Int8_402_i8
	{
...
#line 1187 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Int8.ast"
	auto getCheckedIsqrt($extension_Int8_1177_i8 const& $this ) -> const Builtin::Nullable<$extension_Int8_1177_i8>
	{
		...
		constexpr Builtin::Auto<decltype(Builtin::Cast<true, $extension_Int8_1177_i8>(ADV_USFCS((Math), Isqrt8)(Builtin::Cast<true, Builtin::u8>(ADV_USPCS(MaxValue, $extension_Int8_1177_i8)()))))> MAX_RESULT = Builtin::Cast<true, $extension_Int8_1177_i8>(ADV_USFCS((Math), Isqrt8)(Builtin::Cast<true, Builtin::u8>(ADV_USPCS(MaxValue, $extension_Int8_1177_i8)())));
		#line 1192 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Int8.ast"
		const Builtin::Auto<decltype(Builtin::Cast<true, $extension_Int8_1177_i8>(ADV_USFCS((Math), Isqrt8)(Builtin::Cast<true, Builtin::u8>($this))))> result = Builtin::Cast<true, $extension_Int8_1177_i8>(ADV_USFCS((Math), Isqrt8)(Builtin::Cast<true, Builtin::u8>($this))); 
