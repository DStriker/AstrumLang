...
#line 6 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
	auto Log2Impl(Builtin::f128 x)  -> const Builtin::f128
	{
		...
		if (ADV_UPCS(LowSet)(r.__ref()) == Builtin::i32(0)) {
			...
			return ADV_UPCS(High)(r.__ref()); ADV_CHECK_REF_STRUCT_LOCAL_RETURN("f128", Builtin::f128);
		}
		#line 17 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
		const Builtin::Auto<decltype(ADV_UPCS(High)(r.__ref()) + ADV_UPCS(Low)(r.__ref()))> w = ADV_UPCS(High)(r.__ref()) + ADV_UPCS(Low)(r.__ref()); 
...
#line 46 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
	auto LnImpl(Builtin::f128 x)  -> const Builtin::f128
	{
		...
		return ADV_UPCS(LowSet)(r.__ref()) == Builtin::i32(0) ? ADV_UPCS(High)(r.__ref()) : ADV_UPCS(High)(r.__ref()) + ADV_UPCS(Low)(r.__ref()); ADV_CHECK_REF_STRUCT_LOCAL_RETURN("f128", Builtin::f128);
	}
...
#line 52 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
	auto LnP1Impl(Builtin::f128 x)  -> const Builtin::f128
	{
		...
		Builtin::Auto<decltype(ADV_UFCS(NarrowToInt16)((BiasedExponent(x) | (ADV_UPCS(IsNegative)(x.__ref()) ? Builtin::u16(1U) << Builtin::i32(15) : Builtin::u16(0U))).__ref()))> hx = ADV_UFCS(NarrowToInt16)((BiasedExponent(x) | (ADV_UPCS(IsNegative)(x.__ref()) ? Builtin::u16(1U) << Builtin::i32(15) : Builtin::u16(0U))).__ref()); 
		...
		const Builtin::Auto<decltype(ADV_UFCS(High64)(TrailingSignificand(x).__ref()))> lx = ADV_UFCS(High64)(TrailingSignificand(x).__ref()); 
		#line 98 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
		const Builtin::Auto<decltype(Builtin::i32(-16383) + (hx | (ADV_UPCS(IsNegative)(x.__ref()) ? Builtin::u16(1U) << Builtin::i32(15) : Builtin::u16(0U))))> k = Builtin::i32(-16383) + (hx | (ADV_UPCS(IsNegative)(x.__ref()) ? Builtin::u16(1U) << Builtin::i32(15) : Builtin::u16(0U))); 
		...
		const Builtin::Auto<decltype(ADV_UFCS(NarrowToInt32)(((ADV_UFCS(_operator_add_mod)(lx, (Builtin::u64(1ULL) << (l2i - Builtin::i32(2))))) >> (l2i - Builtin::i32(1))).__ref()))> i = ADV_UFCS(NarrowToInt32)(((ADV_UFCS(_operator_add_mod)(lx, (Builtin::u64(1ULL) << (l2i - Builtin::i32(2))))) >> (l2i - Builtin::i32(1))).__ref()); 
	...
	auto LogInternal(Builtin::f128 x)  -> const LD
	{
		...
		if (ADV_UPCS(IsNegative)(x.__ref()) || ADV_UPCS(IsZero)(x.__ref()) || ADV_UPCS(IsNaN)(x.__ref())) {
			...
			if ((Builtin::u128{hx} | TrailingSignificand(x)) == Builtin::i32(0)) {
				...
				return rp; ADV_CHECK_REF_STRUCT_LOCAL_RETURN("LD", LD);
			}
