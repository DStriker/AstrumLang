...
using TConstant = $ntuples::NamedTuple_772be8e41bda60e3;
#line 164 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
using UConstant = $ntuples::NamedTuple_e60e36e81c207e3e;
#line 165 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
using LD = $ntuples::NamedTuple_1f9d30cf2170c14d;
//###############################################################################
//# Type definitions
//###############################################################################
//###############################################################################
...
#line 155 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
...
#line 158 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
...
#line 438 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
	inline constexpr auto LogConstantH(Builtin::i32 index)  -> const Builtin::f32;
#line 454 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
	inline constexpr auto Sum2(Builtin::MutableRef<Builtin::f128> __a__, Builtin::MutableRef<Builtin::f128> __b__) noexcept -> void;
#line 461 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
	inline constexpr auto Sum3(Builtin::MutableRef<Builtin::f128> __a__, Builtin::MutableRef<Builtin::f128> __b__, Builtin::f64 c) noexcept -> void;
...
#line 473 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
...
#line 129 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
...
#line 133 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
inline constexpr Builtin::u16 ShiftedBiasedExponentMask = Builtin::u16{BiasedExponentMask >> BiasedExponentShift};
#line 135 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
...
#line 145 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
...
#line 148 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
inline constexpr auto SignificandLength = TrailingSignificandLength + Builtin::i32(1);
#line 150 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
...
#line 168 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
...
#line 452 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
...
#line 6 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
	auto Log2Impl(Builtin::f128 x)  -> const Builtin::f128
	{
		...
		constexpr Builtin::Auto<decltype(ADV_USFCS((Builtin::f128), FromBits)(Builtin::ParseUInt128("0x3FFF71547652B82FE24D68D57C9BF07B")))> InvLn2LoPHi = ADV_USFCS((Builtin::f128), FromBits)(Builtin::ParseUInt128("0x3FFF71547652B82FE24D68D57C9BF07B"));
		#line 10 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
		constexpr Builtin::Auto<decltype(ADV_USFCS((Builtin::f128), FromBits)(Builtin::ParseUInt128("0x3FE05C17F0BBBE87FED0691D3E88EB57")))> InvLn2Lo = ADV_USFCS((Builtin::f128), FromBits)(Builtin::ParseUInt128("0x3FE05C17F0BBBE87FED0691D3E88EB57"));
		#line 12 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
		Builtin::Auto<decltype(LogInternal(x))> r = LogInternal(x); 
		#line 13 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
		if (ADV_UPCS(LowSet)(r.$ref()) == Builtin::i32(0)) {
			#line 14 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
			return ADV_UPCS(High)(r.$ref());
		}
		#line 17 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
		const Builtin::Auto<decltype(ADV_UPCS(High)(r.$ref()) + ADV_UPCS(Low)(r.$ref()))> w = ADV_UPCS(High)(r.$ref()) + ADV_UPCS(Low)(r.$ref()); 
		#line 18 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
		ADV_UPCS(Low)(r.$ref()) = ADV_UPCS(High)(r.$ref()) - w + ADV_UPCS(Low)(r.$ref());
		#line 19 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
		ADV_UPCS(High)(r.$ref()) = w;
		#line 21 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
		const Builtin::f128 high = Builtin::Cast<true, Builtin::f32>(ADV_UPCS(High)(r.$ref())); 
		#line 22 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
		const Builtin::f128 low = ADV_UPCS(Low)(r.$ref()) + (ADV_UPCS(High)(r.$ref()) - high); 
		#line 23 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
...
#line 26 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
	auto Log10Impl(Builtin::f128 x)  -> const Builtin::f128
	{
		...
		constexpr Builtin::Auto<decltype(ADV_USFCS((Builtin::f128), FromBits)(Builtin::ParseUInt128("0x3FFDBCB7B1526E50E36BE631DFF2801F")))> InvLn10LoPHi = ADV_USFCS((Builtin::f128), FromBits)(Builtin::ParseUInt128("0x3FFDBCB7B1526E50E36BE631DFF2801F"));
		#line 30 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
		constexpr Builtin::Auto<decltype(ADV_USFCS((Builtin::f128), FromBits)(Builtin::ParseUInt128("0x3FDE37287195355BAAAFAD33DC323EE3")))> InvLn10Lo = ADV_USFCS((Builtin::f128), FromBits)(Builtin::ParseUInt128("0x3FDE37287195355BAAAFAD33DC323EE3"));
		...
		if (ADV_UPCS(LowSet)(r.$ref()) == Builtin::i32(0)) {
			#line 34 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
			return ADV_UPCS(High)(r.$ref());
		}
		...
		ADV_UPCS(Low)(r.$ref()) = ADV_UPCS(High)(r.$ref()) - w + ADV_UPCS(Low)(r.$ref());
		#line 39 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
		ADV_UPCS(High)(r.$ref()) = w;
		...
		const Builtin::f128 low = ADV_UPCS(Low)(r.$ref()) + (ADV_UPCS(High)(r.$ref()) - high); 
		#line 43 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
...
#line 46 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
	auto LnImpl(Builtin::f128 x)  -> const Builtin::f128
	{
		...
		const Builtin::Auto<decltype(LogInternal(x))> r = LogInternal(x); 
		#line 49 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
		return ADV_UPCS(LowSet)(r.$ref()) == Builtin::i32(0) ? ADV_UPCS(High)(r.$ref()) : ADV_UPCS(High)(r.$ref()) + ADV_UPCS(Low)(r.$ref());
	}
...
#line 52 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
	...
	{
		#line 56 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
		Builtin::Auto<decltype(ADV_UFCS(NarrowToInt16)((BiasedExponent(x) | (ADV_UPCS(IsNegative)(x.$ref()) ? Builtin::u16(1U) << Builtin::i32(15) : Builtin::u16(0U))).$ref()))> hx = ADV_UFCS(NarrowToInt16)((BiasedExponent(x) | (ADV_UPCS(IsNegative)(x.$ref()) ? Builtin::u16(1U) << Builtin::i32(15) : Builtin::u16(0U))).$ref()); 
		#line 58 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
		...
		if ((hx <=> Builtin::i32(0x3FFF)) < 0) {
			#line 61 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
			const Builtin::Auto<decltype(hx & Builtin::i32(0x7FFF))> ax = hx & Builtin::i32(0x7FFF); 
			#line 63 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
			if ((ax <=> Builtin::i32(0x3FFF)) >= 0) {
				...
				if (ax == Builtin::i32(0x3FFF) && TrailingSignificand(x) == Builtin::i32(0)) {
					#line 66 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
					return ADV_USPCS(NegativeInfinity, Builtin::f128)();
				}
				#line 70 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
			...
			if ((ax <=> Builtin::i32(0x3F8D)) <= 0 && ADV_UFCS(ToInt64)(x.$ref()) == Builtin::i32(0)) {
				#line 75 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
				return x;
			}
			...
			#line 80 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
			if ((hx <=> Builtin::i32(0x7FFF)) >= 0) {
				...
				#line 83 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
				if ((hx <=> Builtin::i32(0x40E1)) < 0) {
					...
					#line 87 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
					{
						#line 89 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
						fHi = x;
						#line 90 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
						fLo = Builtin::i32(0);
					}
				}
			}
		...
		fLo = fHi - x + fLo;
		#line 95 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
		hx = ADV_UFCS(NarrowToInt16)(BiasedExponent(x).$ref());
		#line 97 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
		const Builtin::Auto<decltype(ADV_UFCS(High64)(TrailingSignificand(x).$ref()))> lx = ADV_UFCS(High64)(TrailingSignificand(x).$ref()); 
		#line 98 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
		const Builtin::Auto<decltype(Builtin::i32(-16383) + (hx | (ADV_UPCS(IsNegative)(x.$ref()) ? Builtin::u16(1U) << Builtin::i32(15) : Builtin::u16(0U))))> k = Builtin::i32(-16383) + (hx | (ADV_UPCS(IsNegative)(x.$ref()) ? Builtin::u16(1U) << Builtin::i32(15) : Builtin::u16(0U))); 
		#line 99 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
		...
		const Builtin::Auto<decltype(ADV_USFCS((Builtin::f128), FromBits)(Builtin::u128{Builtin::u64{Builtin::i32(0x7ffe) - hx} << Builtin::i32(48), Builtin::u32(0U)}))> twopmk = ADV_USFCS((Builtin::f128), FromBits)(Builtin::u128{Builtin::u64{Builtin::i32(0x7ffe) - hx} << Builtin::i32(48), Builtin::u32(0U)}); 
		#line 103 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
		fLo *= twopmk;
		#line 105 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
		const Builtin::Auto<decltype(Builtin::i32(49) - Builtin::i32(7))> l2i = Builtin::i32(49) - Builtin::i32(7); 
		#line 106 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
		const Builtin::Auto<decltype(ADV_UFCS(NarrowToInt32)(((ADV_UFCS(_operator_add_mod)(lx, (Builtin::u64(1ULL) << (l2i - Builtin::i32(2))))) >> (l2i - Builtin::i32(1))).$ref()))> i = ADV_UFCS(NarrowToInt32)(((ADV_UFCS(_operator_add_mod)(lx, (Builtin::u64(1ULL) << (l2i - Builtin::i32(2))))) >> (l2i - Builtin::i32(1))).$ref()); 
		#line 108 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
		Builtin::Auto<decltype((x - LogConstantH(i)) * LogConstantG(i) + LogConstantE(i))> dHi = (x - LogConstantH(i)) * LogConstantG(i) + LogConstantE(i); 
		#line 109 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
		Builtin::Auto<decltype(Builtin::Cast<true, Builtin::f64>((fLo * LogConstantG(i))))> dLo = Builtin::Cast<true, Builtin::f64>((fLo * LogConstantG(i))); 
		#line 111 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
		const Builtin::Auto<decltype(dHi + dLo)> d = dHi + dLo; 
		#line 112 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
		const Builtin::Auto<decltype(Builtin::Cast<true, Builtin::f64>(d))> dd = Builtin::Cast<true, Builtin::f64>(d); 
		...
		#line 114 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
		dHi = d;
		#line 116 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
		...
		#line 120 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
		...
		Sum3(Builtin::MutableRef(resultHi), Builtin::MutableRef(resultLo), LogConstantFHi(i) + dk * LN2HI);
		#line 123 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
...
#line 434 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
	...
	{
		#line 434 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
		ADV_EXPRESSION_BODY(ADV_UPCS(g)(ADV_UFCS(_operator_subscript)(T.$ref(), index).$ref())); 
	}
...
#line 435 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
	...
	{
		#line 435 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
		ADV_EXPRESSION_BODY(ADV_UPCS(fhi)(ADV_UFCS(_operator_subscript)(T.$ref(), index).$ref())); 
	}
...
#line 436 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
	...
	{
		#line 436 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
		ADV_EXPRESSION_BODY(ADV_UPCS(flo)(ADV_UFCS(_operator_subscript)(T.$ref(), index).$ref())); 
	}
...
#line 437 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
	...
	{
		#line 437 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
		ADV_EXPRESSION_BODY(ADV_UPCS(e)(ADV_UFCS(_operator_subscript)(U.$ref(), index).$ref())); 
	}
...
#line 438 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
	...
	{
		#line 438 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
		ADV_EXPRESSION_BODY(ADV_UPCS(h)(ADV_UFCS(_operator_subscript)(U.$ref(), index).$ref())); 
	}
...
#line 454 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
	inline constexpr auto Sum2(Builtin::MutableRef<Builtin::f128> __a__, Builtin::MutableRef<Builtin::f128> __b__) noexcept -> void
	{
		...
		b = a - w + b;
		#line 458 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
		a = w;
	}
...
#line 461 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
	inline constexpr auto Sum3(Builtin::MutableRef<Builtin::f128> __a__, Builtin::MutableRef<Builtin::f128> __b__, Builtin::f64 c) noexcept -> void
	{
		...
		Sum2(Builtin::MutableRef(tmp), Builtin::MutableRef(a));
		#line 465 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
		b += a;
		#line 466 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
		a = tmp;
	}
...
#line 469 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
	inline constexpr auto PackBits(bool sign, Builtin::u16 exponent, Builtin::u128 mantissa)  -> const Builtin::u128
	{
		#line 470 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
...
#line 473 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
	auto LogInternal(Builtin::f128 x)  -> const LD
	{
		...
		Builtin::Auto<decltype(BiasedExponent(x))> hx = BiasedExponent(x); 
		#line 480 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
		Builtin::Auto<decltype(Builtin::i32(-16383))> k = Builtin::i32(-16383); 
		#line 482 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
		if (ADV_UPCS(IsNegative)(x.$ref()) || ADV_UPCS(IsZero)(x.$ref()) || ADV_UPCS(IsNaN)(x.$ref())) {
			...
			if ((Builtin::u128{hx} | TrailingSignificand(x)) == Builtin::i32(0)) {
				...
				ADV_UPCS(High)(rp.$ref()) = ADV_USPCS(NegativeInfinity, Builtin::f128)();
				#line 485 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
				return rp;
			}
			#line 488 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
			ADV_UPCS(High)(rp.$ref()) = ADV_USPCS(NaN, Builtin::f128)();
			#line 489 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
			return rp;
		}
		#line 491 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
		if (ADV_UPCS(IsInfinity)(x.$ref())) {
			#line 492 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
			ADV_UPCS(High)(rp.$ref()) = x;
			#line 493 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
			return rp;
		}
		...
		if (ADV_UPCS(IsSubnormal)(x.$ref())) {
			...
			lx = ADV_UFCS(High64)(TrailingSignificand(x).$ref());
			...
			{
				#line 501 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
				lx = ADV_UFCS(High64)(TrailingSignificand(x).$ref());
			}
		}
		#line 504 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
		k += (hx | (ADV_UPCS(IsNegative)(x.$ref()) ? Builtin::u16(1U) << Builtin::i32(15) : Builtin::u16(0U)));
		#line 505 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
		const Builtin::f64 dk = k; 
		#line 506 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
		x = ADV_USFCS((Builtin::f128), FromBits)(PackBits(Builtin::Boolean(false), Builtin::u16(0x3fffU), TrailingSignificand(x)));
		...
		const Builtin::Auto<decltype((x - LogConstantH(i)) * LogConstantG(i) + LogConstantE(i))> d = (x - LogConstantH(i)) * LogConstantG(i) + LogConstantE(i); 
		#line 511 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
		const Builtin::Auto<decltype(Builtin::Cast<true, Builtin::f64>(d))> dd = Builtin::Cast<true, Builtin::f64>(d); 
		#line 513 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
		...
		#line 517 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
		...
		#line 521 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Float128_Log.ast"
		return rp;
	}
