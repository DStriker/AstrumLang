...
#line 566 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
	auto Decimal::operator<=>(__self other) const noexcept -> const Builtin::i32
	{
		...
		if ((_lo | _hi) == Builtin::u32(0U)) {
			...
			return -((ADV_UPCS(_flags)(other.__ref()) >> Builtin::i32(31)) | Builtin::i32(1)); ADV_CHECK_REF_STRUCT_PARAM_RETURN(other, "i32", Builtin::i32);
		}
		...
		if (sign != Builtin::i32(0)) {
			...
			return sign; ADV_CHECK_REF_STRUCT_LOCAL_RETURN("i32", Builtin::i32);
		}
...
#line 584 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
	auto Decimal::AddSub(__self other, bool sign) const  -> const __self
	{
		...
		auto flipSign = [&] () 
		{
			...
			return __self{low, high, ADV_UFCS(NarrowToInt32)(flags.__ref())}; ADV_CHECK_REF_STRUCT_LOCAL_RETURN("self", __self);
		}; 
		...
		if (high == Builtin::i32(0)) {
			...
			if ((low <=> ADV_USPCS(MaxValue, Builtin::u32)()) <= 0) {
				...
				if (Builtin::u32{low} == Builtin::i32(0)) {
					...
					return result; ADV_CHECK_REF_STRUCT_LOCAL_RETURN("self", __self);
				}
		...
		while ((scale <=> Builtin::i32(0)) > 0) 
		{
			...
			{	using namespace Builtin::Unsafe;	using namespace System::__Unsafe;	using namespace __Decimal_Protected__Unsafe;	Builtin::UnsafeContextGuard __unsafe_context_guard760{};
		...
		auto noCarry = [&] () 
		{
			...
			{	using namespace Builtin::Unsafe;	using namespace System::__Unsafe;	using namespace __Decimal_Protected__Unsafe;	Builtin::UnsafeContextGuard __unsafe_context_guard791{};
		...
		if (sign) {
			...
			{	using namespace Builtin::Unsafe;	using namespace System::__Unsafe;	using namespace __Decimal_Protected__Unsafe;	Builtin::UnsafeContextGuard __unsafe_context_guard815{};
			...
			#line 826 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
			{
				...
				{	using namespace Builtin::Unsafe;	using namespace System::__Unsafe;	using namespace __Decimal_Protected__Unsafe;	Builtin::UnsafeContextGuard __unsafe_context_guard840{};
...
#line 857 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
	auto Decimal::Mul(__self other) const  -> const __self
	{
		...
		auto skipScan = [&] () 
		{
			...
			{	using namespace Builtin::Unsafe;	using namespace System::__Unsafe;	using namespace __Decimal_Protected__Unsafe;	Builtin::UnsafeContextGuard __unsafe_context_guard868{};
				...
				return __self{ADV_UPCS(Low64)(buf.__ref()), ADV_UPCS(u2)(ADV_UPCS(DWords)(buf.__ref()).__ref()), ADV_UFCS(NarrowToInt32)((((otherFlags ^ flags) & __Decimal_Protected::SignMask) | (Builtin::u32{scale} << __Decimal_Protected::ScaleShift)).__ref())}; ADV_CHECK_REF_STRUCT_LOCAL_RETURN("self", __self);
			}
		}; 
		...
		if ((_hi | (_lo >> Builtin::i32(32))) == Builtin::u32(0U)) {
			...
			if ((ADV_UPCS(_hi)(other.__ref()) | (ADV_UPCS(_lo)(other.__ref()) >> Builtin::i32(32))) == Builtin::u32(0U)) {
				...
				return __self{low64, Builtin::u32(0U), ADV_UFCS(NarrowToInt32)((((otherFlags ^ flags) & __Decimal_Protected::SignMask) | (Builtin::u32{scale} << __Decimal_Protected::ScaleShift)).__ref())}; ADV_CHECK_REF_STRUCT_LOCAL_RETURN("self", __self);
			} else {
		...
		{	using namespace Builtin::Unsafe;	using namespace System::__Unsafe;	using namespace __Decimal_Protected__Unsafe;	Builtin::UnsafeContextGuard __unsafe_context_guard993{};
...
#line 1005 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
	auto Decimal::Div(__self other) const  -> const __self
	{
		...
		{	using namespace Builtin::Unsafe;	using namespace System::__Unsafe;	using namespace __Decimal_Protected__Unsafe;	Builtin::UnsafeContextGuard __unsafe_context_guard1016{};
			...
			auto doUnscale = [&] () 
			{
				...
				if (unscale) {
					...
					return __self{Builtin::u64{low} | (Builtin::u64{ADV_UFCS(NarrowToUInt32)(high.__ref())} << Builtin::i32(32)), ADV_UFCS(NarrowToUInt32)((high >> Builtin::i32(32)).__ref()), ADV_UFCS(NarrowToInt32)((((flags ^ otherFlags) & __Decimal_Protected::SignMask) | (ADV_UFCS(NarrowToUInt32)(scale.__ref()) << __Decimal_Protected::ScaleShift)).__ref())}; ADV_CHECK_REF_STRUCT_LOCAL_RETURN("self", __self);
				} else {
			...
			auto overflowUnscale = [&] (bool sticky) 
			{
				...
				ADV_ASSERT((ADV_UPCS(u2)(ADV_UPCS(DWords)(buf.__ref()).__ref()) == Builtin::u32(0U)), "buf.DWords.u2==0u");
				...
				return scale; ADV_CHECK_REF_STRUCT_LOCAL_RETURN("self", __self);
			}; 
			...
			if ((ADV_UPCS(_hi)(other.__ref()) | (ADV_UPCS(_lo)(other.__ref()) >> Builtin::i32(32))) == Builtin::u32(0U)) {
				...
				auto remainder = [&] () 
				{
					...
					if (ADV_UPCS(u2)(ADV_UPCS(DWords)(buf.__ref()).__ref()) != Builtin::u32(0U)) {
						...
						return ADV_UFCS(_operator_sub_mod)(ADV_UFCS(NarrowToUInt32)(tmp2.__ref()), ADV_UFCS(_operator_mul_mod)(div32, den)); ADV_CHECK_REF_STRUCT_LOCAL_RETURN("self", __self);
					}
				...
				#line 1162 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
				{
					...
					if (ADV_UPCS(_hi)(other.__ref()) == Builtin::u32(0U)) {
						...
						ADV_UPCS(u1)(ADV_UPCS(DWords)(buf.__ref()).__ref()) = Div96By64(Builtin::MutableRef(((*(UnsafePointerCast<Buf12>((__RawPtr(std::addressof(ADV_UPCS(u1)(ADV_UPCS(DWords)(bufRem.__ref()).__ref()))))))))), divisor);
						#line 1179 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
						ADV_UPCS(u0)(ADV_UPCS(DWords)(buf.__ref()).__ref()) = Div96By64(Builtin::MutableRef(((*(UnsafePointerCast<Buf12>((__RawPtr(std::addressof(bufRem)))))))), divisor);
						...
						#line 1218 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
						{
							...
							ADV_UPCS(Low64)(buf.__ref()) = Div128By96(Builtin::MutableRef(bufRem), Builtin::MutableRef(bufDivisor));
							...
							for (;;) 
							{
								...
								ADV_UPCS(u3)(ADV_UPCS(DWords)(bufRem.__ref()).__ref()) = increaseScale(Builtin::MutableRef(((*(UnsafePointerCast<Buf12>((__RawPtr(std::addressof(bufRem)))))))));
...
#line 1277 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
	auto Decimal::Mod(__self other) const  -> const __self
	{
		...
		{	using namespace Builtin::Unsafe;	using namespace System::__Unsafe;	using namespace __Decimal_Protected__Unsafe;	Builtin::UnsafeContextGuard __unsafe_context_guard1321{};
			...
			#line 1322 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
			{
				...
				if (high == Builtin::u32(0U)) {
					...
					ADV_ASSERT((ADV_UPCS(_hi)(other.__ref()) == Builtin::u32(0U)), "other._hi==0u");
					...
					return __self{low, Builtin::u32(0U), ADV_UFCS(NarrowToInt32)(flags.__ref())}; ADV_CHECK_REF_STRUCT_LOCAL_RETURN("self", __self);
				} else {
						...
						#line 1360 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
						{
							...
							if (ADV_UPCS(_hi)(other.__ref()) == Builtin::u32(0U)) {
								...
								if ((h <=> Builtin::u32(5U)) > 0) {
									...
									Div96By64(Builtin::MutableRef(((*(UnsafePointerCast<Buf12>((__RawPtr(std::addressof(ADV_UPCS(u4)(ADV_UPCS(DWords)(ADV_UPCS(buf24)(buf.__ref()).__ref()).__ref()))))))))), divisor);
								}
								...
								if ((h <=> Builtin::u32(4U)) > 0) {
									...
									Div96By64(Builtin::MutableRef(((*(UnsafePointerCast<Buf12>((__RawPtr(std::addressof(ADV_UPCS(u3)(ADV_UPCS(DWords)(ADV_UPCS(buf24)(buf.__ref()).__ref()).__ref()))))))))), divisor);
								}
								...
								if ((h <=> Builtin::u32(3U)) > 0) {
									...
									Div96By64(Builtin::MutableRef(((*(UnsafePointerCast<Buf12>((__RawPtr(std::addressof(ADV_UPCS(u2)(ADV_UPCS(DWords)(ADV_UPCS(buf24)(buf.__ref()).__ref()).__ref()))))))))), divisor);
								}
								#line 1400 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
								Div96By64(Builtin::MutableRef(((*(UnsafePointerCast<Buf12>((__RawPtr(std::addressof(ADV_UPCS(u1)(ADV_UPCS(DWords)(ADV_UPCS(buf24)(buf.__ref()).__ref()).__ref()))))))))), divisor);
								...
								#line 1404 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
								{
									...
									if ((h <=> Builtin::u32(5U)) > 0) {
										...
										Div128By96(Builtin::MutableRef(((*(UnsafePointerCast<Buf16>((__RawPtr(std::addressof(ADV_UPCS(u3)(ADV_UPCS(DWords)(ADV_UPCS(buf24)(buf.__ref()).__ref()).__ref()))))))))), Builtin::MutableRef(bufDivisor));
									}
									...
									if ((h <=> Builtin::u32(4U)) > 0) {
										...
										Div128By96(Builtin::MutableRef(((*(UnsafePointerCast<Buf16>((__RawPtr(std::addressof(ADV_UPCS(u2)(ADV_UPCS(DWords)(ADV_UPCS(buf24)(buf.__ref()).__ref()).__ref()))))))))), Builtin::MutableRef(bufDivisor));
									}
									...
									if ((h <=> Builtin::u32(3U)) > 0) {
										...
										Div128By96(Builtin::MutableRef(((*(UnsafePointerCast<Buf16>((__RawPtr(std::addressof(ADV_UPCS(u1)(ADV_UPCS(DWords)(ADV_UPCS(buf24)(buf.__ref()).__ref()).__ref()))))))))), Builtin::MutableRef(bufDivisor));
									}
...
#line 1488 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
	auto Decimal::RoundInternal(Builtin::u32 scale, MidpointRounding mode) const noexcept -> const __self
	{
				...
				if (n == Builtin::i32(0)) {
					...
					if (tmp == Builtin::i32(0)) {
						...
						if ((mode <=> ADV_USPCS(ToZero, MidpointRounding)()) <= 0) {
							...
							return copy; ADV_CHECK_REF_STRUCT_LOCAL_RETURN("self", __self);
						}
		...
		#line 1566 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
		{
			...
			auto __tmp__valid_1566 = Builtin::Cast<false, std::decay_t<decltype(mode)>::__self>(mode);
			#line 1567 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
			if(__tmp__valid_1566.IsValid() && Builtin::Is(*__tmp__valid_1566, decltype(mode)::ToZero))  {
				#line 1567 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
				...
				if(__tmp__valid_1566.IsValid() && Builtin::Is(*__tmp__valid_1566, decltype(mode)::ToEven))  {
					#line 1568 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
					const auto& mode = *__tmp__valid_1566;
					#line 1568 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
					{
					...
					if(__tmp__valid_1566.IsValid() && Builtin::Is(*__tmp__valid_1566, decltype(mode)::AwayFromZero))  {
						#line 1576 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
						const auto& mode = *__tmp__valid_1566;
						#line 1576 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
						{
						...
						if(__tmp__valid_1566.IsValid() && Builtin::Is(*__tmp__valid_1566, decltype(mode)::ToNegativeInfinity))  {
							#line 1581 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
							const auto& mode = *__tmp__valid_1566;
							#line 1581 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
							{
...
#line 2573 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
	...
	{	using namespace Builtin::Unsafe;	using namespace System::__Unsafe;	using namespace __Decimal_Protected__Unsafe;
...
ADV_WARNING_DISABLE(4715, -Wreturn-type)
						{
							...
							auto __tmp__valid_2756 = Builtin::Cast<false, std::decay_t<decltype(newScale)>::__self>(newScale);
							#line 2757 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
...
ADV_WARNING_DISABLE(4715, -Wreturn-type)
							{
								...
								auto __tmp__valid_2768 = Builtin::Cast<false, std::decay_t<decltype(newScale)>::__self>(newScale);
								#line 2769 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
...
ADV_WARNING_POP
			...
			return scale; ADV_CHECK_REF_STRUCT_PARAM_RETURN(scale, "i32", Builtin::i32);
		}
	}
...
namespace __Unsafe { [[clang::annotate("unsafe")]] 
		...
		{	using namespace Builtin::Unsafe;	using namespace System::__Unsafe;	using namespace __Decimal_Protected__Unsafe;
			...
			auto haveScale = [&] () 
			{
				...
				return currentScale; ADV_CHECK_REF_STRUCT_LOCAL_RETURN("i32", Builtin::i32);
			}; 
...
namespace __Unsafe { [[clang::annotate("unsafe")]] 
		...
		{	using namespace Builtin::Unsafe;	using namespace System::__Unsafe;	using namespace __Decimal_Protected__Unsafe;
			...
			ADV_ASSERT(((den <=> ADV_UPCS(High64)(buf.__ref())) > 0), "den>buf.High64");
			...
			if (num2 == Builtin::u32(0U)) {
				...
				return quo; ADV_CHECK_REF_STRUCT_LOCAL_RETURN("u32", Builtin::u32);
			}
...
namespace __Unsafe { [[clang::annotate("unsafe")]] 
		...
		{	using namespace Builtin::Unsafe;	using namespace System::__Unsafe;	using namespace __Decimal_Protected__Unsafe;
			...
			ADV_ASSERT(((ADV_UPCS(u2)(ADV_UPCS(DWords)(bufDen.__ref()).__ref()) <=> ADV_UPCS(u3)(ADV_UPCS(DWords)(buf.__ref()).__ref())) > 0), "bufDen.DWords.u2>buf.DWords.u3");
...
#line 3117 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
	...
	static bool __Test_7e8bf6dec0b23b8a = [](){
		...
		ADV_ASSERT((ADV_UPCS(Truncate)(d.__ref()) == Builtin::i32(-1)), "d.Truncate==-1");
		#line 3176 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
		ADV_ASSERT((ADV_UPCS(Truncate)(System::Decimal(Builtin::ParseUInt128("2678"), false, (uint8_t) 3).__ref()) == Builtin::i32(2)), "2.678m.Truncate==2");
		#line 3177 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
		ADV_ASSERT((ADV_UFCS(TruncateToInt32)(d.__ref()) == Builtin::i32(-1)), "d.TruncateToInt32()==-1");
		#line 3178 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
		ADV_ASSERT((ADV_UPCS(Floor)(d.__ref()) == Builtin::i32(-2)), "d.Floor==-2");
		#line 3179 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
		ADV_ASSERT((ADV_UFCS(FloorToInt32)(d.__ref()) == Builtin::i32(-2)), "d.FloorToInt32()==-2");
		#line 3180 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
		ADV_ASSERT((ADV_UPCS(Floor)(System::Decimal(Builtin::ParseUInt128("2678"), false, (uint8_t) 3).__ref()) == Builtin::i32(2)), "2.678m.Floor==2");
		#line 3181 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
		ADV_ASSERT((ADV_UPCS(Ceil)(d.__ref()) == Builtin::i32(-1)), "d.Ceil==-1");
		#line 3182 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
		ADV_ASSERT((ADV_UFCS(CeilToInt32)(d.__ref()) == Builtin::i32(-1)), "d.CeilToInt32()==-1");
		#line 3183 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
		ADV_ASSERT((ADV_UPCS(Ceil)(System::Decimal(Builtin::ParseUInt128("2678"), false, (uint8_t) 3).__ref()) == Builtin::i32(3)), "2.678m.Ceil==3");
		#line 3184 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
		ADV_ASSERT((ADV_UPCS(Round)(d.__ref()) == Builtin::i32(-1)), "d.Round==-1");
		#line 3185 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
		ADV_ASSERT((ADV_UFCS(RoundToInt32)(d.__ref()) == Builtin::i32(-1)), "d.RoundToInt32()==-1");
		#line 3186 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
		ADV_ASSERT((ADV_UPCS(RoundTiesEven)(d.__ref()) == Builtin::i32(-1)), "d.RoundTiesEven==-1");
		#line 3187 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
		ADV_ASSERT((ADV_UFCS(RoundTiesEvenToInt32)(d.__ref()) == Builtin::i32(-1)), "d.RoundTiesEvenToInt32()==-1");
		#line 3188 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
		ADV_ASSERT((ADV_UPCS(Round)(System::Decimal(Builtin::ParseUInt128("2678"), false, (uint8_t) 3).__ref()) == Builtin::i32(3)), "2.678m.Round==3");
		#line 3189 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
		ADV_ASSERT((ADV_UPCS(Round)(System::Decimal(Builtin::ParseUInt128("25"), false, (uint8_t) 1).__ref()) == Builtin::i32(3)), "2.5m.Round==3");
		#line 3190 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
		ADV_ASSERT((ADV_UPCS(RoundTiesEven)(System::Decimal(Builtin::ParseUInt128("25"), false, (uint8_t) 1).__ref()) == Builtin::i32(2)), "2.5m.RoundTiesEven==2");
		#line 3191 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
		ADV_ASSERT((ADV_UFCS(Round)(d.__ref(), Builtin::u32(2U)) == System::Decimal(Builtin::ParseUInt128("123"), true, (uint8_t) 2)), "d.Round(2u)==-1.23m");
		...
		ADV_ASSERT((ADV_UFCS(_operator_subscript)(bits.__ref(), Builtin::u32(0U)) == Builtin::u32(2080661269U)), "bits[0u]==2080661269u");
		#line 3196 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
		ADV_ASSERT((ADV_UFCS(_operator_subscript)(bits.__ref(), Builtin::u32(1U)) == Builtin::u32(4075008415U)), "bits[1u]==4075008415u");
		#line 3197 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
		ADV_ASSERT((ADV_UFCS(_operator_subscript)(bits.__ref(), Builtin::u32(2U)) == Builtin::u32(6692605U)), "bits[2u]==6692605u");
		#line 3198 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
		ADV_ASSERT((ADV_UFCS(_operator_subscript)(bits.__ref(), Builtin::u32(3U)) == Builtin::u32(589824U)), "bits[3u]==589824u");
		...
		ADV_ASSERT((ADV_UPCS(Exp)(System::Decimal(Builtin::ParseUInt128("12345"), false, (uint8_t) 3).__ref()) == System::Decimal(Builtin::ParseUInt128("22980812486124595475041888612"), false, (uint8_t) 23)), "12.345m.Exp==229808.12486124595475041888612m");
		#line 3202 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
		ADV_ASSERT((ADV_UPCS(Exp2)(System::Decimal(Builtin::ParseUInt128("12345"), false, (uint8_t) 3).__ref()) == System::Decimal(Builtin::ParseUInt128("52025384244788822035143417228"), false, (uint8_t) 25)), "12.345m.Exp2==5202.5384244788822035143417228m");
		#line 3203 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
		ADV_ASSERT((ADV_UPCS(Exp10)(System::Decimal(Builtin::ParseUInt128("12345"), false, (uint8_t) 3).__ref()) == System::Decimal(Builtin::ParseUInt128("22130947096056377223339808814"), false, (uint8_t) 16)), "12.345m.Exp10==2213094709605.6377223339808814m");
		#line 3204 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
		ADV_ASSERT((ADV_UPCS(Ln)(System::Decimal(Builtin::ParseUInt128("12345"), false, (uint8_t) 3).__ref()) == System::Decimal(Builtin::ParseUInt128("25132511227971428258519031703"), false, (uint8_t) 28)), "12.345m.Ln==2.5132511227971428258519031703m");
		#line 3205 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
		ADV_ASSERT((ADV_UPCS(Log2)(System::Decimal(Builtin::ParseUInt128("12345"), false, (uint8_t) 3).__ref()) == System::Decimal(Builtin::ParseUInt128("36258549313680571627010290442"), false, (uint8_t) 28)), "12.345m.Log2==3.6258549313680571627010290442m");
		#line 3206 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
		ADV_ASSERT((ADV_UPCS(Log10)(System::Decimal(Builtin::ParseUInt128("12345"), false, (uint8_t) 3).__ref()) == System::Decimal(Builtin::ParseUInt128("10914910942679510818489967645"), false, (uint8_t) 28)), "12.345m.Log10==1.0914910942679510818489967645m");
		#line 3207 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
		ADV_ASSERT((ADV_UFCS(Log)(System::Decimal(Builtin::ParseUInt128("12345"), false, (uint8_t) 3).__ref(), Builtin::i32(4)) == System::Decimal(Builtin::ParseUInt128("18129274656840285813505145227"), false, (uint8_t) 28)), "12.345m.Log(4)==1.8129274656840285813505145227m");
		#line 3208 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
		ADV_ASSERT((ADV_UPCS(Sqrt)(System::Decimal(Builtin::ParseUInt128("12345"), false, (uint8_t) 3).__ref()) == System::Decimal(Builtin::ParseUInt128("35135452181521728638212225535"), false, (uint8_t) 28)), "12.345m.Sqrt==3.5135452181521728638212225535m");
		#line 3209 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
		ADV_ASSERT((ADV_UFCS(Root)(System::Decimal(Builtin::ParseUInt128("123345"), false, (uint8_t) 3).__ref(), Builtin::i32(5)) == System::Decimal(Builtin::ParseUInt128("26195356295079193440029636649"), false, (uint8_t) 28)), "123.345m.Root(5)==2.6195356295079193440029636649m");
		#line 3210 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
		ADV_ASSERT((ADV_UFCS(Hypot)(System::Decimal(Builtin::ParseUInt128("12345"), false, (uint8_t) 3).__ref(), System::Decimal(Builtin::ParseUInt128("13475"), false, (uint8_t) 3)) == System::Decimal(Builtin::ParseUInt128("18274973324193937110010809348"), false, (uint8_t) 27)), "12.345m.Hypot(13.475m)==18.274973324193937110010809348m");
		#line 3211 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
		ADV_ASSERT((ADV_UPCS(Sin)(System::Decimal(Builtin::ParseUInt128("12345"), false, (uint8_t) 3).__ref()) == System::Decimal(Builtin::ParseUInt128("02195669967379331208777903957"), true, (uint8_t) 28)), "12.345m.Sin==-0.2195669967379331208777903957m");
		#line 3212 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
		ADV_ASSERT((ADV_UPCS(Cos)(System::Decimal(Builtin::ParseUInt128("12345"), false, (uint8_t) 3).__ref()) == System::Decimal(Builtin::ParseUInt128("09755974241168764311137172336"), false, (uint8_t) 28)), "12.345m.Cos==0.9755974241168764311137172336m");
		#line 3213 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
		ADV_ASSERT((ADV_UPCS(Tan)(System::Decimal(Builtin::ParseUInt128("12345"), false, (uint8_t) 3).__ref()) == System::Decimal(Builtin::ParseUInt128("02250590164654114812867215792"), true, (uint8_t) 28)), "12.345m.Tan==-0.2250590164654114812867215792m");
		#line 3214 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
		ADV_ASSERT((ADV_UPCS(Asin)(System::Decimal(Builtin::ParseUInt128("0345"), false, (uint8_t) 3).__ref()) == System::Decimal(Builtin::ParseUInt128("03522387850970647507525367312"), false, (uint8_t) 28)), "0.345m.Asin==0.3522387850970647507525367312m");
		#line 3215 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
		ADV_ASSERT((ADV_UPCS(Acos)(System::Decimal(Builtin::ParseUInt128("0345"), false, (uint8_t) 3).__ref()) == System::Decimal(Builtin::ParseUInt128("12185575416978318684787849604"), false, (uint8_t) 28)), "0.345m.Acos==1.2185575416978318684787849604m");
		#line 3216 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
		ADV_ASSERT((ADV_UPCS(Atan)(System::Decimal(Builtin::ParseUInt128("0345"), false, (uint8_t) 3).__ref()) == System::Decimal(Builtin::ParseUInt128("03322135507465967447407006541"), false, (uint8_t) 28)), "0.345m.Atan==0.3322135507465967447407006541m");
		#line 3217 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
		ADV_ASSERT((ADV_UPCS(Sinh)(System::Decimal(Builtin::ParseUInt128("12345"), false, (uint8_t) 3).__ref()) == System::Decimal(Builtin::ParseUInt128("11490406242844724925288177915"), false, (uint8_t) 23)), "12.345m.Sinh==114904.06242844724925288177915m");
		#line 3218 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
		ADV_ASSERT((ADV_UPCS(Cosh)(System::Decimal(Builtin::ParseUInt128("12345"), false, (uint8_t) 3).__ref()) == System::Decimal(Builtin::ParseUInt128("11490406243279870549753710697"), false, (uint8_t) 23)), "12.345m.Cosh==114904.06243279870549753710697m");
		#line 3219 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
		ADV_ASSERT((ADV_UPCS(Tanh)(System::Decimal(Builtin::ParseUInt128("12345"), false, (uint8_t) 3).__ref()) == System::Decimal(Builtin::ParseUInt128("09999999999621296571024173851"), false, (uint8_t) 28)), "12.345m.Tanh==0.9999999999621296571024173851m");
		#line 3220 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
		ADV_ASSERT((ADV_UPCS(Asinh)(System::Decimal(Builtin::ParseUInt128("12345"), false, (uint8_t) 3).__ref()) == System::Decimal(Builtin::ParseUInt128("32080347119330812566459538762"), false, (uint8_t) 28)), "12.345m.Asinh==3.2080347119330812566459538762m");
		#line 3221 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
		ADV_ASSERT((ADV_UPCS(Acosh)(System::Decimal(Builtin::ParseUInt128("12345"), false, (uint8_t) 3).__ref()) == System::Decimal(Builtin::ParseUInt128("32047538216182560379240045553"), false, (uint8_t) 28)), "12.345m.Acosh==3.2047538216182560379240045553m");
		#line 3222 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
		ADV_ASSERT((ADV_UPCS(Atanh)(System::Decimal(Builtin::ParseUInt128("0345"), false, (uint8_t) 3).__ref()) == System::Decimal(Builtin::ParseUInt128("03597570282003437810352645844"), false, (uint8_t) 28)), "0.345m.Atanh==0.3597570282003437810352645844m");
		return true;
	}();
	#endif	
} namespace __extensions { using namespace System;
#line 1615 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
	auto _operator_eq_eq_mul(__extension_Decimal_1613_decimal const& __this LIFETIMEBOUND, Builtin::In<Builtin::Nullable<Builtin::ObjectRef>> obj)  -> const bool
	{
		#line 1617 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
		{
			#line 1617 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
			auto __tmp0 = Builtin::Cast<false, __extension_Decimal_1613_decimal>(obj);
			#line 1617 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
			if ((__tmp0.IsValid())) {
				#line 1617 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
...
#line 1629 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
	auto getHashCode(__extension_Decimal_1613_decimal const& __this ) -> const Builtin::u64
	{
...
#line 1680 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
	auto _operator_lt_eq_gt_mul(__extension_Decimal_1679_decimal const& __this LIFETIMEBOUND, Builtin::In<Builtin::Nullable<Builtin::ObjectRef>> obj)  -> const Builtin::i32
	{
		#line 1682 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
		{
			#line 1682 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
			auto __tmp0 = Builtin::Cast<false, __extension_Decimal_1679_decimal>(obj);
			#line 1682 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
			if ((__tmp0.IsValid())) {
				#line 1682 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
				const auto& obj = *__tmp0;
...
#line 1872 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
	auto Parse(__extension_Decimal_1778_decimal const& __this LIFETIMEBOUND, Builtin::Str input)  -> const typename __extension_Decimal_1778_decimal
	{
...
#line 1877 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
	auto TryParse(__extension_Decimal_1778_decimal const& __this LIFETIMEBOUND, Builtin::Str input) noexcept -> const Builtin::Nullable<__extension_Decimal_1778_decimal>
	{
...
#line 2001 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
	auto Round(__extension_Decimal_1932_decimal const& __this LIFETIMEBOUND, Builtin::u32 decimals, MidpointRounding mode)  -> const typename __extension_Decimal_1932_decimal
	{
		...
		if (scale != Builtin::i32(0)) {
			...
			return ADV_UFCS(RoundInternal)(__this.__ref(), scale, mode); ADV_CHECK_REF_STRUCT_LOCAL_RETURN("self", __extension_Decimal_1932_decimal);
		}
...
#line 1937 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
	auto getTruncate(__extension_Decimal_1932_decimal const& __this ) -> const __extension_Decimal_1932_decimal
	{
...
#line 1949 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
	auto getFloor(__extension_Decimal_1932_decimal const& __this ) -> const __extension_Decimal_1932_decimal
	{
...
#line 1961 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
	auto getCeil(__extension_Decimal_1932_decimal const& __this ) -> const __extension_Decimal_1932_decimal
	{
...
#line 1973 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
	auto getRound(__extension_Decimal_1932_decimal const& __this ) -> const __extension_Decimal_1932_decimal
	{
...
#line 1985 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
	auto getRoundTiesEven(__extension_Decimal_1932_decimal const& __this ) -> const __extension_Decimal_1932_decimal
	{
...
#line 2025 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
	auto _operator_mul_mul(__extension_Decimal_2024_decimal const& __this LIFETIMEBOUND, __extension_Decimal_2024_decimal exp)  -> const typename __extension_Decimal_2024_decimal
	{
		...
		if (exp == Builtin::i32(0)) {
			...
			return ADV_USPCS(One, __extension_Decimal_2024_decimal)();
		}
		...
		if (exp == ADV_USPCS(MinusOne, __extension_Decimal_2024_decimal)()) {
			#line 2047 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
			return ADV_USPCS(One, __extension_Decimal_2024_decimal)() / __this;
		}
...
#line 2074 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
	auto getExp(__extension_Decimal_2072_decimal const& __this ) -> const __extension_Decimal_2072_decimal
	{
		...
		while ((x <=> ADV_USPCS(One, __extension_Decimal_2072_decimal)()) > 0) 
		{
		...
		Builtin::Auto<decltype(ADV_USPCS(One, __extension_Decimal_2072_decimal)())> result = ADV_USPCS(One, __extension_Decimal_2072_decimal)(); 
		#line 2090 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
		Builtin::Auto<decltype(ADV_USPCS(One, __extension_Decimal_2072_decimal)())> factor = ADV_USPCS(One, __extension_Decimal_2072_decimal)(); 
...
#line 2118 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
	auto getLn(__extension_Decimal_2116_decimal const& __this ) -> const __extension_Decimal_2116_decimal
	{
		...
		while ((x <=> ADV_USPCS(One, __extension_Decimal_2116_decimal)()) >= 0) 
		{
		...
		Builtin::Auto<decltype(ADV_USPCS(Zero, __extension_Decimal_2116_decimal)())> result = ADV_USPCS(Zero, __extension_Decimal_2116_decimal)(); 
		...
		Builtin::Auto<decltype(ADV_USPCS(One, __extension_Decimal_2116_decimal)())> y = ADV_USPCS(One, __extension_Decimal_2116_decimal)(); 
...
#line 2202 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
	auto Root(__extension_Decimal_2180_decimal const& __this LIFETIMEBOUND, Builtin::i32 n)  -> const typename __extension_Decimal_2180_decimal
	{
		#line 2204 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
		auto PositiveN = [&] (__extension_Decimal_2180_decimal x, Builtin::i32 n) 
		{
			#line 2206 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
			__extension_Decimal_2180_decimal result{}; 
			...
			if (x != Builtin::i32(0)) {
				...
				if ((x <=> Builtin::i32(0)) > 0 || ADV_UPCS(IsOddInteger)(n.__ref())) {
					...
					result = ADV_UFCS(_operator_mul_mul)(ADV_UPCS(Abs)(x.__ref()), (ADV_USPCS(One, __extension_Decimal_2180_decimal)() / n));
			...
			return result; ADV_CHECK_REF_STRUCT_LOCAL_RETURN("self", __extension_Decimal_2180_decimal);
		}; 
		#line 2223 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
		auto NegativeN = [&] (__extension_Decimal_2180_decimal x, Builtin::i32 n) 
		{
...
ADV_WARNING_DISABLE(4715, -Wreturn-type)
				{
					...
					auto __tmp__valid_2243 = Builtin::Cast<false, std::decay_t<decltype(n)>::__self>(n);
					#line 2245 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
...
#line 2255 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
	auto Hypot(__extension_Decimal_2180_decimal const& __this LIFETIMEBOUND, __extension_Decimal_2180_decimal y)  -> const typename __extension_Decimal_2180_decimal
	{
...
#line 2182 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
	auto getSqrt(__extension_Decimal_2180_decimal const& __this ) -> const __extension_Decimal_2180_decimal
	{
...
#line 2279 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
	auto getSin(__extension_Decimal_2277_decimal const& __this ) -> const __extension_Decimal_2277_decimal
	{
		...
		const Builtin::Auto<decltype(ADV_UPCS(Sqrt)((ADV_USPCS(One, __extension_Decimal_2277_decimal)() - cos * cos).__ref()))> sinModule = ADV_UPCS(Sqrt)((ADV_USPCS(One, __extension_Decimal_2277_decimal)() - cos * cos).__ref()); 
...
#line 2310 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
	auto getCos(__extension_Decimal_2277_decimal const& __this ) -> const __extension_Decimal_2277_decimal
	{
...
#line 2341 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
	auto getTan(__extension_Decimal_2277_decimal const& __this ) -> const __extension_Decimal_2277_decimal
	{
...
#line 2357 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
	auto getAsin(__extension_Decimal_2277_decimal const& __this ) -> const __extension_Decimal_2277_decimal
	{
		...
		const Builtin::Auto<decltype(ADV_USPCS(One, __extension_Decimal_2277_decimal)() - __this * __this * Builtin::i32(2))> newX = ADV_USPCS(One, __extension_Decimal_2277_decimal)() - __this * __this * Builtin::i32(2); 
		...
		Builtin::Auto<decltype(ADV_USPCS(Zero, __extension_Decimal_2277_decimal)())> y = ADV_USPCS(Zero, __extension_Decimal_2277_decimal)(); 
		...
		#line 2386 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
		{
			...
			result *= xx * (ADV_USPCS(One, __extension_Decimal_2277_decimal)() - System::Decimal(Builtin::ParseUInt128("05"), false, (uint8_t) 1) / i);
...
#line 2395 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
	auto getAcos(__extension_Decimal_2277_decimal const& __this ) -> const __extension_Decimal_2277_decimal
	{
...
#line 2411 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
	auto getAtan(__extension_Decimal_2277_decimal const& __this ) -> const __extension_Decimal_2277_decimal
	{
...
ADV_WARNING_DISABLE(4715, -Wreturn-type)
		{
			...
			auto __tmp__valid_2413 = Builtin::Cast<false, std::decay_t<decltype(__this)>::__self>(__this);
			#line 2414 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
			if(__tmp__valid_2413.IsValid() && Builtin::Is(*__tmp__valid_2413, Builtin::i32(0))) {
				#line 2414 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
				
				return ADV_USPCS(Zero, __extension_Decimal_2277_decimal)();
			}
			else {
				...
				if(__tmp__valid_2413.IsValid() && Builtin::Is(*__tmp__valid_2413, Builtin::i32(1))) {
					...
					return ADV_UPCS(Asin)((__this / ADV_UPCS(Sqrt)((ADV_USPCS(One, __extension_Decimal_2277_decimal)() + __this * __this).__ref())).__ref());
...
#line 2462 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
	auto getAcosh(__extension_Decimal_2460_decimal const& __this ) -> const __extension_Decimal_2460_decimal
	{
...
#line 2477 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
	auto getAsinh(__extension_Decimal_2460_decimal const& __this ) -> const __extension_Decimal_2460_decimal
	{
...
#line 2482 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
	auto getAtanh(__extension_Decimal_2460_decimal const& __this ) -> const __extension_Decimal_2460_decimal
	{
		...
		return System::Decimal(Builtin::ParseUInt128("05"), false, (uint8_t) 1) * ADV_UPCS(Ln)(((ADV_USPCS(One, __extension_Decimal_2460_decimal)() + __this) / (ADV_USPCS(One, __extension_Decimal_2460_decimal)() - __this)).__ref());
	}
	} namespace System{
} namespace __extensions { using namespace System;
#line 2491 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
	auto getCosh(__extension_Decimal_2460_decimal const& __this ) -> const __extension_Decimal_2460_decimal
	{
...
#line 2502 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
	auto getSinh(__extension_Decimal_2460_decimal const& __this ) -> const __extension_Decimal_2460_decimal
	{
...
#line 2507 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Decimal.ast"
	auto getTanh(__extension_Decimal_2460_decimal const& __this ) -> const __extension_Decimal_2460_decimal
	{
