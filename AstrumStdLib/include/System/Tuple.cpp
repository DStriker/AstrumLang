...
//###############################################################################
	...
	static bool $Test_c84237d747284489 = [](){
		...
		Builtin::Tuple<Builtin::i32, Builtin::i32, Builtin::StaticStr> t1 = Builtin::MakeTuple(Builtin::i32(12), Builtin::i32(34), Builtin::StaticStr{"Hello"}); 
		#line 8 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Tuple.ast"
		auto t2 = Builtin::MakeTuple(Builtin::i32(12), Builtin::i32(34), Builtin::StaticStr{"Hello"}); 
		#line 9 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Tuple.ast"
		t2 = Builtin::MakeTuple(Builtin::i32(13), Builtin::i32(35), Builtin::StaticStr{"Bye bye"});
		...
		const auto& [i10, i20, s1] = Builtin::MakeTuple(Builtin::i32(12), Builtin::i32(34), Builtin::StaticStr{"Hello"});
		...
		ADV_ASSERT((s1 == Builtin::StaticStr{"Hello"}), "s1==\"Hello\"");
		...
		ADV_ASSERT((get<2>(t2) == Builtin::StaticStr{"Bye bye"}), "t2.2==\"Bye bye\"");
		...
		ADV_ASSERT((get<2>(t3) == Builtin::StaticStr{"Hello"}), "t3.2==\"Hello\"");
		...
		ADV_ASSERT((get<5>(t3) == Builtin::StaticStr{"Bye bye"}), "t3.5==\"Bye bye\"");
		...
		auto sa1 = Builtin::StaticStr{"test"}; 
		#line 32 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Tuple.ast"
		Builtin::Tie(ia1, ia2, sa1) = Builtin::MakeTuple(Builtin::i32(12), Builtin::i32(34), Builtin::StaticStr{"Hello"});
		...
		ADV_ASSERT((sa1 == Builtin::StaticStr{"Hello"}), "sa1==\"Hello\"");
		#line 36 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Tuple.ast"
		Builtin::Tie(ia1, std::ignore, sa1) = Builtin::MakeTuple(Builtin::i32(1234), Builtin::i32(3456), Builtin::StaticStr{"Hello world"});
		...
		ADV_ASSERT((sa1 == Builtin::StaticStr{"Hello world"}), "sa1==\"Hello world\"");
		return true;
	}();
	#endif	
