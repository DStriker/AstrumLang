...
//###############################################################################
	...
	static bool __Test_be5a992cf08145d0 = [](){
		...
		ADV_ASSERT((ADV_UPCS(Start)(irange.__ref()) == ADV_USPCS(Start, Index)()), "irange.Start==Index.Start");
		#line 278 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Range.ast"
		ADV_ASSERT((ADV_UPCS(End)(irange.__ref()) == ADV_USPCS(End, Index)()), "irange.End==Index.End");
		#line 279 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Range.ast"
		ADV_ASSERT((!ADV_UPCS(IsClosed)(irange.__ref())), "notirange.IsClosed");
		...
		ADV_ASSERT((ADV_UFCS(Length)(irange.__ref(), Builtin::u32(10U)) == Builtin::u32(10U)), "irange.Length(10u)==10u");
		...
		ADV_ASSERT((ADV_UPCS(IsClosed)(irange.__ref())), "irange.IsClosed");
		#line 285 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Range.ast"
		ADV_ASSERT((ADV_UFCS(Length)(irange.__ref(), Builtin::u32(10U)) == Builtin::u32(11U)), "irange.Length(10u)==11u");
		...
		ADV_ASSERT((ADV_UPCS(Start)(irange.__ref()) == ADV_USFCS((Index), FromStart)(Builtin::u32(2U))), "irange.Start==Index.FromStart(2u)");
		#line 289 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\Range.ast"
		ADV_ASSERT((ADV_UPCS(End)(irange.__ref()) == ADV_USFCS((Index), FromEnd)(Builtin::u32(2U))), "irange.End==Index.FromEnd(2u)");
		...
		ADV_ASSERT((ADV_UFCS(Length)(irange.__ref(), Builtin::u32(10U)) == Builtin::u32(6U)), "irange.Length(10u)==6u");
		...
		ADV_ASSERT((ADV_UFCS(Length)(irange.__ref(), Builtin::u32(10U)) == Builtin::u32(7U)), "irange.Length(10u)==7u");
		...
		ADV_ASSERT((ADV_UFCS(Length)(irange.__ref(), Builtin::u32(10U)) == Builtin::u32(9U)), "irange.Length(10u)==9u");
		...
		ADV_ASSERT((ADV_UFCS(Length)(irange.__ref(), Builtin::u32(10U)) == Builtin::u32(8U)), "irange.Length(10u)==8u");
		...
		ADV_ASSERT((ADV_UPCS(End)(irange.__ref()) == ADV_USFCS((Index), FromStart)(Builtin::u32(6U))), "irange.End==Index.FromStart(6u)");
		...
		ADV_ASSERT((ADV_UFCS(Length)(irange.__ref(), Builtin::u32(10U)) == Builtin::u32(4U)), "irange.Length(10u)==4u");
