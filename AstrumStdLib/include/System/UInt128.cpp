...
static_assert(ADV_UFCS_NONLOCAL(_operator_add_or)(ADV_USPCS(MaxValue, Builtin::u128)(), Builtin::u128(1ULL)) == ADV_USPCS(MaxValue, Builtin::u128)(), "u128.MaxValue +| 1u128 == u128.MaxValue");
	...
	static bool __Test_89d751813d6ab908 = [](){
		...
		ADV_UFCS(_operator_bsl_eq)(a, Builtin::u128(2ULL));
		...
		a = ADV_USPCS(MaxValue, Builtin::u128)() - Builtin::u128(1ULL);
		...
		#line 1498 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\UInt128.ast"
		{
			...
			const auto& [result, overflowed] = ADV_UFCS(CarryingAdd)(a.__ref(), Builtin::u128(0ULL), false);
		...
		#line 1502 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\UInt128.ast"
		{
			...
			const auto& [result, overflowed] = ADV_UFCS(CarryingAdd)(a.__ref(), Builtin::u128(0ULL), true);
		...
		#line 1506 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\UInt128.ast"
		{
			...
			const auto& [result, overflowed] = ADV_UFCS(CarryingAdd)(a.__ref(), Builtin::u128(10ULL), true);
		...
		a = ADV_USPCS(MinValue, Builtin::u128)() + Builtin::u128(1ULL);
		...
		#line 1538 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\UInt128.ast"
		{
			...
			const auto& [result, overflowed] = ADV_UFCS(BorrowingSub)(a.__ref(), Builtin::u128(0ULL), false);
		...
		#line 1542 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\UInt128.ast"
		{
			...
			const auto& [result, overflowed] = ADV_UFCS(BorrowingSub)(a.__ref(), Builtin::u128(0ULL), true);
		...
		#line 1546 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\UInt128.ast"
		{
			...
			const auto& [result, overflowed] = ADV_UFCS(BorrowingSub)(a.__ref(), Builtin::u128(10ULL), true);
		...
		ADV_UFCS(_operator_mod_mod_eq)(a, Builtin::u128(6ULL));
...
#line 568 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\UInt128.ast"
	template<class T> auto _operator_add_mod_qst(__extension_UInt128_512_u128 const& __this LIFETIMEBOUND, T rhs) noexcept -> const std::tuple<__extension_UInt128_1258_u128, bool>
	{
...
#line 660 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\UInt128.ast"
	template<class T> auto _operator_sub_mod_qst(__extension_UInt128_512_u128 const& __this LIFETIMEBOUND, T rhs) noexcept -> const std::tuple<__extension_UInt128_1258_u128, bool>
	{
...
#line 734 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\UInt128.ast"
	template<class T> auto _operator_mul_mod_qst(__extension_UInt128_512_u128 const& __this LIFETIMEBOUND, T rhs) noexcept -> const std::tuple<__extension_UInt128_1258_u128, bool>
	{
...
#line 857 "C:\\Users\\user\\Documents\\VSProjects\\MyLanguage\\AstrumStdLib\\include\\System\\UInt128.ast"
	template<class T> auto _operator_mod_mod_qst(__extension_UInt128_512_u128 const& __this LIFETIMEBOUND, T rhs)  -> const std::tuple<__extension_UInt128_1258_u128, bool>
	{
