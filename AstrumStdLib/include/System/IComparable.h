...
namespace System {
	...
	template<class __AnyType> concept __HasMethodImplementation_ebb8f6f8d5632898 = requires(typename __AnyType::__class t) { {t._operator_lt_eq_gt_qst(std::declval<Builtin::Nullable<Builtin::ObjectRef>>())} -> std::convertible_to<Builtin::i32>; }  || requires(__AnyType t) { {_operator_lt_eq_gt_qst(__extensions::__proxy<__AnyType>{t}, std::declval<Builtin::Nullable<Builtin::ObjectRef>>())} -> std::convertible_to<Builtin::i32>; } || requires { { [] { using namespace __extensions; return _operator_lt_eq_gt_qst(std::declval<__AnyType>(), std::declval<Builtin::Nullable<Builtin::ObjectRef>>()); }() } -> std::convertible_to<Builtin::i32>; };
	namespace __vtables {
...
namespace System {
	...
	template<class __AnyType, class T> concept __HasMethodImplementation_ff4bfa67cd0092cc = requires(typename __AnyType::__class t) { {t.operator<=>(std::declval<Builtin::Nullable<T>>())} -> std::convertible_to<Builtin::i32>; }  || requires(__AnyType t) { {operator<=>(__extensions::__proxy<__AnyType>{t}, std::declval<Builtin::Nullable<T>>())} -> std::convertible_to<Builtin::i32>; } || requires { { [] { using namespace __extensions; return operator<=>(std::declval<__AnyType>(), std::declval<Builtin::Nullable<T>>()); }() } -> std::convertible_to<Builtin::i32>; };
	namespace __vtables {
