...
#ifdef ADV_VERSION_LITTLE_ENDIAN
...
#define SET_LOW_WORD(d, v)                                                                         \
	...
	int32_t __kernel_rem_pio2(double* x, double* y, int32_t e0, int32_t nx, int32_t prec,
	...
	std::int32_t RemPiO2(double x, double* y) noexcept {
