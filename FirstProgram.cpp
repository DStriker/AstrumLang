...
auto main(CppAdvance::i32 iparam, CppAdvance::In<CppAdvance::f64> jparam)  -> const int
{
	...
	#line 669 "FirstProgram.adv"
	{
		...
		#line 670 "FirstProgram.adv"
		CppAdvance::Stackalloc<ConcreteVectorClass> __obj_670_33(CppAdvance::i32(10), CppAdvance::Str{u"123455555555"}); CppAdvance::InitStackObject((CppAdvance::Object*)__obj_670_33.obj);
		#line 670 "FirstProgram.adv"
		CppAdvance::Nullable<VectorClass> nxt2 = __obj_670_33; 
		...
		print(ADV_UFCS(_operator_bsl_mul_div)(ADV_UFCS(_operator_bsl_mul_div)(CppAdvance::i32(3), CppAdvance::i32(10)), CppAdvance::i32(5)));
