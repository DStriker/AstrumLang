...
template<class T> using __extension_556_T = T;
#line 559 "FirstProgram.adv"
template<class T> inline auto operator*(__extension_556_T<T> const& __this LIFETIMEBOUND, CppAdvance::In<CppAdvance::f32> f)  -> const CppAdvance::f32;
#line 561 "FirstProgram.adv"
template<class T> inline auto PrintInterface(__extension_556_T<T> const& __this LIFETIMEBOUND, CppAdvance::i32 x)  -> const CppAdvance::i32;
#line 569 "FirstProgram.adv"
template<class T> inline const CppAdvance::f32 getAt(__extension_556_T<T> const& __this LIFETIMEBOUND, CppAdvance::f32 r, CppAdvance::f32 g, CppAdvance::f32 b);
#line 569 "FirstProgram.adv"
template<class T> inline const CppAdvance::f32 _operator_subscript(__extension_556_T<T> const& __this LIFETIMEBOUND, CppAdvance::f32 r, CppAdvance::f32 g, CppAdvance::f32 b) { return getAt(__this, r, g, b); }
#line 571 "FirstProgram.adv"
template<class T> inline auto __construct_(CppAdvance::ConstructorProxy<__extension_556_T<T>> __ctordata, CppAdvance::i32 x, CppAdvance::Str txt)  -> decltype(auto);
#line 576 "FirstProgram.adv"
template<class T> inline auto __construct_(CppAdvance::ConstructorProxy<__extension_556_T<T>> __ctordata, typename CppAdvance::MemorySpace mem, CppAdvance::i32 x, CppAdvance::Str txt)  -> decltype(auto);
#line 557 "FirstProgram.adv"
template<class T> inline auto getAsString(__extension_556_T<T> const& __this ) -> const CppAdvance::Str;
...
extern "C" auto __Astrum_Main()  -> CppAdvance::i32
{
	...
	#line 667 "FirstProgram.adv"
	{
		...
		#line 668 "FirstProgram.adv"
		CppAdvance::Stackalloc<ConcreteVectorClass> __obj_668_33(CppAdvance::i32(10), CppAdvance::Str{u"123455555555"}); CppAdvance::InitStackObject((CppAdvance::Object*)__obj_668_33.obj);
		#line 668 "FirstProgram.adv"
		CppAdvance::Nullable<VectorClass> nxt2 = __obj_668_33; 
