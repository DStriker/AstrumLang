...
auto main(CppAdvance::i32 iparam, CppAdvance::In<CppAdvance::f64> jparam)  -> int
{
	...
	CppAdvance::Nullable<IInterface> nxt = CppAdvance::New<ConcreteVectorClass>(CppAdvance::i32(1), CppAdvance::i32(2), CppAdvance::i32(3)); 
	#line 429 "FirstProgram.adv"
	{
		...
		print(ADV_UFCS(GetMagicNumber)((*(nxt)).__ref(), CppAdvance::i32(3)));
		#line 434 "FirstProgram.adv"
		print(ADV_UFCS(GetMagicNumber)((*(nxt)).__ref(), CppAdvance::i32(5)));
		#line 435 "FirstProgram.adv"
		ADV_UFCS(Reset)((*(nxt)).__ref());
