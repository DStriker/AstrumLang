...
auto main(CppAdvance::i32 iparam, CppAdvance::In<CppAdvance::f64> jparam)  -> const int
{
	...
	#line 536 "FirstProgram.adv"
	{
		...
		#line 537 "FirstProgram.adv"
		CppAdvance::Stackalloc<ConcreteVectorClass> __obj_537_33(CppAdvance::i32(10), CppAdvance::Str{u"123455555555"}); CppAdvance::InitStackObject((CppAdvance::Object*)__obj_537_33.obj);
		#line 537 "FirstProgram.adv"
		CppAdvance::Nullable<VectorClass> nxt2 = __obj_537_33; 
		...
		print(ADV_USPCS(Count2, VectorClass)());
		#line 558 "FirstProgram.adv"
		ADV_USPCS(Count2, VectorClass)() = CppAdvance::i32(145);
		#line 559 "FirstProgram.adv"
		print(ADV_USPCS(Count2, VectorClass)());
		#line 560 "FirstProgram.adv"
		print(ADV_USFCS((VectorClass), Method)(CppAdvance::i32(1), CppAdvance::i32(2), CppAdvance::i32(3)));
		#line 561 "FirstProgram.adv"
		print(ADV_USPCS(Count3, VectorClass)());
		#line 562 "FirstProgram.adv"
		print(ADV_USFCS((VectorClass), GetSuperCount)(CppAdvance::i32(5), CppAdvance::i32(7)));
