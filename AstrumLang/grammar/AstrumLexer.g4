...
lexer grammar AstrumLexer;

// base class that need for string interpolation processing
...
Op1: (
        NonCmpOpChar OperatorChar*
        | '<<' NonGtLtOpChar OperatorChar*
        | '>>' NonGtLtOpChar OperatorChar*
    ) '='
;
...
// text processing in interpolated string literal
...
// format processing in interpolated string literal
