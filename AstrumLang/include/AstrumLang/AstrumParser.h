	...
	class ASTRUMLANG_API AstrumParser : public antlr4::Parser {
	   public:
		enum {
			...
			OrAssign                         = 163,
			LeftShiftAssign                  = 164,
			RightShiftAssign                 = 165,
			SignedRightShiftAssign           = 166,
			Equal                            = 167,
			NotEqual                         = 168,
			IdentityEqual                    = 169,
			NotIdentityEqual                 = 170,
			Spaceship                        = 171,
			LessEqual                        = 172,
			GreaterEqual                     = 173,
			PlusPlus                         = 174,
			...
			Op8                              = 201,
			Op9                              = 202,
			DOUBLE_CURLY_INSIDE              = 203,
			OPEN_BRACE_INSIDE                = 204,
			REGULAR_CHAR_INSIDE              = 205,
			VERBATIUM_DOUBLE_GRAVE_INSIDE    = 206,
			MULTILINE_QUOTES_INSIDE          = 207,
			DOUBLE_QUOTE_INSIDE              = 208,
			GRAVE_INSIDE                     = 209,
			TRIPLE_QUOTE_INSIDE              = 210,
			REGULAR_STRING_INSIDE            = 211,
			GRAVE_STRING_INSIDE              = 212,
			MULTILINE_STRING_INSIDE          = 213,
			CLOSE_BRACE_INSIDE               = 214,
			FORMAT_STRING                    = 215,
			DOUBLE_CURLY_CLOSE_INSIDE        = 216
		};
		...
		enum {
			...
			RulePackageName                         = 2,
			RuleNestedPackageName                   = 3,
			RuleModuleName                          = 4,
			RuleImportDeclaration                   = 5,
			RuleDeclarationSeq                      = 6,
			RuleDeclaration                         = 7,
			RuleSymbolSpecifierSeq                  = 8,
			RuleVersionDefinition                   = 9,
			RuleExternVariableDeclaration           = 10,
			RuleBlockDeclaration                    = 11,
			RuleMemberBlockDeclaration              = 12,
			RuleAssertDeclaration                   = 13,
			RuleAssumeDeclaration                   = 14,
			RuleUnitTestDeclaration                 = 15,
			RuleDeclarationCompoundStatement        = 16,
			RuleVersionConditionalDeclaration       = 17,
			RuleVersionIfDeclaration                = 18,
			RuleVersionElseDeclaration              = 19,
			RuleDeclSpecifier                       = 20,
			RuleDeclSpecifierSeq                    = 21,
			RuleIdentifierSeq                       = 22,
			RuleSimpleDeclaration                   = 23,
			RuleBitFieldDeclaration                 = 24,
			RuleDeconstructionDeclaration           = 25,
			RuleRefDeclaration                      = 26,
			RuleMemberRefDeclaration                = 27,
			RuleSimpleMultiDeclaration              = 28,
			RuleMultiDeclaration                    = 29,
			RuleConstantDeclaration                 = 30,
			RuleForwardVarDeclaration               = 31,
			RuleAliasDeclaration                    = 32,
			RuleAccessSpecifier                     = 33,
			RuleProtectedInternal                   = 34,
			RuleStatement                           = 35,
			RuleLabeledStatement                    = 36,
			RuleDeclarationStatement                = 37,
			RuleExpressionStatement                 = 38,
			RuleCompoundStatement                   = 39,
			RuleSelectionStatement                  = 40,
			RuleCondition                           = 41,
			RuleElseBranch                          = 42,
			RuleSwitchStatementBranch               = 43,
			RuleDeclarator                          = 44,
			RuleInlineCppStatement                  = 45,
			RuleIterationStatement                  = 46,
			RuleWhileCondition                      = 47,
			RuleDoWhileCondition                    = 48,
			RuleForInitStatement                    = 49,
			RuleForRangeDeclaration                 = 50,
			RuleForRangeInitializer                 = 51,
			RuleExpressionSeq                       = 52,
			RuleJumpStatement                       = 53,
			RuleVersionSelectionStatement           = 54,
			RuleVersionSelectionStatementBlock      = 55,
			RuleScopeSafeCompoundStatement          = 56,
			RuleTryBlock                            = 57,
			RuleExceptionHandler                    = 58,
			RuleExceptionDeclaration                = 59,
			RuleExpression                          = 60,
			RuleRangeExpression                     = 61,
			RuleRangeExpressionStart                = 62,
			RuleRangeExpressionEnd                  = 63,
			RuleSwitchExpression                    = 64,
			RuleSwitchExpressionBranch              = 65,
			RulePowerExpression                     = 66,
			RuleMultiplicativeExpression            = 67,
			RuleAdditiveExpression                  = 68,
			RuleShiftExpression                     = 69,
			RuleThreeWayComparisonExpression        = 70,
			RuleRelationalExpression                = 71,
			RuleEqualityExpression                  = 72,
			RuleAndExpression                       = 73,
			RuleExclusiveOrExpression               = 74,
			RuleInclusiveOrExpression               = 75,
			RuleLogicalAndExpression                = 76,
			RuleLogicalOrExpression                 = 77,
			RuleNullCoalescingExpression            = 78,
			RuleNullCoalescingBranch                = 79,
			RuleConditionalExpression               = 80,
			RuleConstantExpression                  = 81,
			RuleAssignmentExpression                = 82,
			RuleInitializerClause                   = 83,
			RuleBracedInitList                      = 84,
			RuleInitializerList                     = 85,
			RuleInitializerPart                     = 86,
			RuleExpressionList                      = 87,
			RuleExpressionListPart                  = 88,
			RuleThrowExpression                     = 89,
			RuleIdExpression                        = 90,
			RuleQualifiedId                         = 91,
			RuleUnqualifiedId                       = 92,
			RuleUnaryExpression                     = 93,
			RuleUnaryExpressionTail                 = 94,
			RuleNewExpression                       = 95,
			RuleStackallocExpression                = 96,
			RuleMemorySpaceSetter                   = 97,
			RuleNewInitializer                      = 98,
			RuleFullPostfixExpression               = 99,
			RulePostfixExpression                   = 100,
			RuleTupleExpression                     = 101,
			RuleMethodBindingExpression             = 102,
			RuleMethodOwnerExpression               = 103,
			RuleMethodName                          = 104,
			RulePrimaryExpression                   = 105,
			RuleFoldExpression                      = 106,
			RuleFoldLeftExpression                  = 107,
			RuleFoldRightExpression                 = 108,
			RuleDeclvalExpression                   = 109,
			RuleLambdaExpression                    = 110,
			RuleLambdaCaptureList                   = 111,
			RuleLambdaCaptureClause                 = 112,
			RuleCapture                             = 113,
			RuleLambdaDeclarator                    = 114,
			RuleLambdaBody                          = 115,
			RuleTheTypeId                           = 116,
			RuleSingleTypeId                        = 117,
			RuleTypePostfix                         = 118,
			RuleArrayDeclarator                     = 119,
			RulePointerOperator                     = 120,
			RulePointerOperatorSeq                  = 121,
			RuleTypeSpecifierSeq                    = 122,
			RuleTypeSpecifier                       = 123,
			RuleTrailingTypeSpecifier               = 124,
			RuleTypeNameSpecifier                   = 125,
			RuleCvQualifierSeq                      = 126,
			RuleCvQualifier                         = 127,
			RuleTypename                            = 128,
			RuleClassName                           = 129,
			RuleDecltypeSpecifier                   = 130,
			RuleDecaySpecifier                      = 131,
			RuleEnumName                            = 132,
			RuleSimpleTypeSpecifier                 = 133,
			RuleFunctionTypeId                      = 134,
			RuleTypeIdWithSpecification             = 135,
			RuleNamedTupleField                     = 136,
			RuleNestedNameSpecifier                 = 137,
			RuleNamespaceName                       = 138,
			RuleTemplateName                        = 139,
			RuleSimpleTemplateId                    = 140,
			RuleOperatorTemplateId                  = 141,
			RuleTemplateId                          = 142,
			RulePatternList                         = 143,
			RulePatternCombinationOperator          = 144,
			RulePattern                             = 145,
			RulePropertyPattern                     = 146,
			RuleStructDefinition                    = 147,
			RuleStructHead                          = 148,
			RuleStructMemberSpecification           = 149,
			RuleMemberDeclarationCompoundStatement  = 150,
			RuleMemberVersionConditionalDeclaration = 151,
			RuleMemberVersionIfDeclaration          = 152,
			RuleMemberVersionElseDeclaration        = 153,
			RuleStructMemberDeclaration             = 154,
			RuleClassDefinition                     = 155,
			RuleClassHead                           = 156,
			RuleInterfaceDefinition                 = 157,
			RuleInterfaceHead                       = 158,
			RuleInterfaceMemberSpecification        = 159,
			RuleInterfaceMemberDeclaration          = 160,
			RuleAssociatedTypeDeclaration           = 161,
			RuleEnumDefinition                      = 162,
			RuleEnumHead                            = 163,
			RuleEnumBase                            = 164,
			RuleEnumList                            = 165,
			RuleEnumeratorDefinition                = 166,
			RuleEnumMemberSpecification             = 167,
			RuleEnumMemberDeclaration               = 168,
			RuleEnumClassDefinition                 = 169,
			RuleEnumClassHead                       = 170,
			RuleEnumClassList                       = 171,
			RuleClassEnumeratorDefinition           = 172,
			RuleEnumClassMemberSpecification        = 173,
			RuleUnionDefinition                     = 174,
			RuleUnionHead                           = 175,
			RuleUnionList                           = 176,
			RuleUnionEnumerator                     = 177,
			RuleUnionEnumeratorClause               = 178,
			RuleUnionMemberSpecification            = 179,
			RuleExtensionDefinition                 = 180,
			RuleExtensionHead                       = 181,
			RuleExtensionMemberSpecification        = 182,
			RuleExtensionMemberDeclaration          = 183,
			RuleBaseClause                          = 184,
			RuleBaseSpecifierList                   = 185,
			RuleBaseSpecifier                       = 186,
			RuleProperty                            = 187,
			RulePropertyBody                        = 188,
			RuleAbstractProperty                    = 189,
			RuleInterfaceProperty                   = 190,
			RulePropertyGetter                      = 191,
			RulePropertySetter                      = 192,
			RuleAbstractPropertyGetter              = 193,
			RuleAbstractPropertySetter              = 194,
			RuleExternFunctionDeclaration           = 195,
			RuleFunctionTemplateDeclaration         = 196,
			RuleFunctionDefinition                  = 197,
			RuleAbstractMethodDeclaration           = 198,
			RuleInterfaceMethodDeclaration          = 199,
			RuleFunctionSpecifier                   = 200,
			RuleFunctionParams                      = 201,
			RuleParamDeclClause                     = 202,
			RuleParamDeclList                       = 203,
			RuleParamDeclaration                    = 204,
			RuleParamSpecification                  = 205,
			RuleReturnType                          = 206,
			RuleFunctionBody                        = 207,
			RuleShortFunctionBody                   = 208,
			RuleExceptionSpecification              = 209,
			RuleFriendDeclaration                   = 210,
			RuleExternMethodDeclaration             = 211,
			RuleOperatorFunctionId                  = 212,
			RuleConstructor                         = 213,
			RuleConstructorBody                     = 214,
			RuleMemberInitializationList            = 215,
			RuleDelegatingConstructorBody           = 216,
			RuleDelegatingConstructorStatement      = 217,
			RuleMemberInitializationStatement       = 218,
			RuleImplicitSpecification               = 219,
			RuleDestructor                          = 220,
			RuleConversionFunction                  = 221,
			RuleConversionFunctionId                = 222,
			RuleIndexer                             = 223,
			RuleIndexerProperty                     = 224,
			RuleIndexerGetter                       = 225,
			RuleIndexerSetter                       = 226,
			RuleInterfaceIndexer                    = 227,
			RuleTemplateParams                      = 228,
			RuleTemplateParamDeclaration            = 229,
			RuleTemplateTypename                    = 230,
			RuleTemplateArgumentList                = 231,
			RuleTemplateArgument                    = 232,
			RuleConstraintClause                    = 233,
			RuleTypeTrait                           = 234,
			RuleTemplateDeductionGuide              = 235,
			RuleAttributeSpecifierSeq               = 236,
			RuleAttributeSpecifier                  = 237,
			RuleAttributeArgumentClause             = 238,
			RuleAssignmentOperator                  = 239,
			RuleShiftOperator                       = 240,
			RuleUnaryPrefixOperator                 = 241,
			RuleUnaryCustomOperator                 = 242,
			RuleRefCaptureOperator                  = 243,
			RuleUnaryPostfixOperator                = 244,
			RuleNot                                 = 245,
			RuleOperator                            = 246,
			RuleLiteral                             = 247,
			RuleInterpolatedStringLiteral           = 248,
			RuleInterpolatedRegularStringLiteral    = 249,
			RuleInterpolatedRegularStringPart       = 250,
			RuleInterpolatedVerbatiumStringLiteral  = 251,
			RuleInterpolatedVerbatiumStringPart     = 252,
			RuleInterpolatedMultilineStringLiteral  = 253,
			RuleInterpolatedMultilineStringPart     = 254,
			RuleInterpolatedExpression              = 255
		};

		explicit AstrumParser(antlr4::TokenStream* input);

		AstrumParser(antlr4::TokenStream* input,
		...
		class ASTRUMLANG_API ExternVariableDeclarationContext : public antlr4::ParserRuleContext {
		   public:
			ExternVariableDeclarationContext(antlr4::ParserRuleContext* parent,
		...
		class ASTRUMLANG_API DeclarationCompoundStatementContext
		    : public antlr4::ParserRuleContext {
		   public:
			DeclarationCompoundStatementContext(antlr4::ParserRuleContext* parent,
			                                    size_t invokingState);
			virtual size_t getRuleIndex() const override;
		...
		class ASTRUMLANG_API VersionConditionalDeclarationContext
		    : public antlr4::ParserRuleContext {
		   public:
			VersionConditionalDeclarationContext(antlr4::ParserRuleContext* parent,
			                                     size_t invokingState);
			virtual size_t getRuleIndex() const override;
		...
		class ASTRUMLANG_API DeconstructionDeclarationContext : public antlr4::ParserRuleContext {
		   public:
			DeconstructionDeclarationContext(antlr4::ParserRuleContext* parent,
			                                 size_t invokingState);
			virtual size_t getRuleIndex() const override;
			IdentifierSeqContext* identifierSeq();
			antlr4::tree::TerminalNode* Colon();
		...
		class ASTRUMLANG_API VersionSelectionStatementContext : public antlr4::ParserRuleContext {
		   public:
			VersionSelectionStatementContext(antlr4::ParserRuleContext* parent,
			                                 size_t invokingState);
			virtual size_t getRuleIndex() const override;
			antlr4::tree::TerminalNode* If();
			antlr4::tree::TerminalNode* Version();
		...
		class ASTRUMLANG_API VersionSelectionStatementBlockContext
		    : public antlr4::ParserRuleContext {
		   public:
			VersionSelectionStatementBlockContext(antlr4::ParserRuleContext* parent,
			                                      size_t invokingState);
			virtual size_t getRuleIndex() const override;
			ScopeSafeCompoundStatementContext* scopeSafeCompoundStatement();
			StatementContext* statement();
		...
		class ASTRUMLANG_API ScopeSafeCompoundStatementContext : public antlr4::ParserRuleContext {
		   public:
			ScopeSafeCompoundStatementContext(antlr4::ParserRuleContext* parent,
			                                  size_t invokingState);
			virtual size_t getRuleIndex() const override;
			antlr4::tree::TerminalNode* LeftBrace();
			antlr4::tree::TerminalNode* RightBrace();
		...
		class ASTRUMLANG_API ThreeWayComparisonExpressionContext
		    : public antlr4::ParserRuleContext {
		   public:
			ThreeWayComparisonExpressionContext(antlr4::ParserRuleContext* parent,
			                                    size_t invokingState);
			virtual size_t getRuleIndex() const override;
			std::vector<ShiftExpressionContext*> shiftExpression();
			ShiftExpressionContext* shiftExpression(size_t i);
		...
		class ASTRUMLANG_API NullCoalescingExpressionContext : public antlr4::ParserRuleContext {
		   public:
			NullCoalescingExpressionContext(antlr4::ParserRuleContext* parent,
			                                size_t invokingState);
			virtual size_t getRuleIndex() const override;
			LogicalOrExpressionContext* logicalOrExpression();
		...
		class ASTRUMLANG_API PatternCombinationOperatorContext : public antlr4::ParserRuleContext {
		   public:
			PatternCombinationOperatorContext(antlr4::ParserRuleContext* parent,
			                                  size_t invokingState);
			virtual size_t getRuleIndex() const override;
		...
		class ASTRUMLANG_API StructMemberSpecificationContext : public antlr4::ParserRuleContext {
		   public:
			StructMemberSpecificationContext(antlr4::ParserRuleContext* parent,
			                                 size_t invokingState);
			virtual size_t getRuleIndex() const override;
		...
		class ASTRUMLANG_API MemberDeclarationCompoundStatementContext
		    : public antlr4::ParserRuleContext {
		   public:
			MemberDeclarationCompoundStatementContext(antlr4::ParserRuleContext* parent,
			                                          size_t invokingState);
			virtual size_t getRuleIndex() const override;
			antlr4::tree::TerminalNode* LeftBrace();
			antlr4::tree::TerminalNode* RightBrace();
		...
		class ASTRUMLANG_API MemberVersionConditionalDeclarationContext
		    : public antlr4::ParserRuleContext {
		   public:
			MemberVersionConditionalDeclarationContext(antlr4::ParserRuleContext* parent,
			                                           size_t invokingState);
			virtual size_t getRuleIndex() const override;
			antlr4::tree::TerminalNode* If();
		...
		class ASTRUMLANG_API MemberVersionIfDeclarationContext : public antlr4::ParserRuleContext {
		   public:
			MemberVersionIfDeclarationContext(antlr4::ParserRuleContext* parent,
			                                  size_t invokingState);
			virtual size_t getRuleIndex() const override;
		...
		class ASTRUMLANG_API MemberVersionElseDeclarationContext
		    : public antlr4::ParserRuleContext {
		   public:
			MemberVersionElseDeclarationContext(antlr4::ParserRuleContext* parent,
			                                    size_t invokingState);
			virtual size_t getRuleIndex() const override;
			StructMemberDeclarationContext* structMemberDeclaration();
			MemberDeclarationCompoundStatementContext* memberDeclarationCompoundStatement();
		...
		class ASTRUMLANG_API InterfaceMemberSpecificationContext
		    : public antlr4::ParserRuleContext {
		   public:
			InterfaceMemberSpecificationContext(antlr4::ParserRuleContext* parent,
			                                    size_t invokingState);
			virtual size_t getRuleIndex() const override;
		...
		class ASTRUMLANG_API InterfaceMemberDeclarationContext : public antlr4::ParserRuleContext {
		   public:
			InterfaceMemberDeclarationContext(antlr4::ParserRuleContext* parent,
			                                  size_t invokingState);
			virtual size_t getRuleIndex() const override;
			FunctionDefinitionContext* functionDefinition();
			AttributeSpecifierSeqContext* attributeSpecifierSeq();
		...
		class ASTRUMLANG_API AssociatedTypeDeclarationContext : public antlr4::ParserRuleContext {
		   public:
			AssociatedTypeDeclarationContext(antlr4::ParserRuleContext* parent,
			                                 size_t invokingState);
			virtual size_t getRuleIndex() const override;
			antlr4::tree::TerminalNode* Type();
			antlr4::tree::TerminalNode* Identifier();
		...
		class ASTRUMLANG_API ClassEnumeratorDefinitionContext : public antlr4::ParserRuleContext {
		   public:
			ClassEnumeratorDefinitionContext(antlr4::ParserRuleContext* parent,
			                                 size_t invokingState);
			virtual size_t getRuleIndex() const override;
			antlr4::tree::TerminalNode* Identifier();
			AttributeSpecifierSeqContext* attributeSpecifierSeq();
		...
		class ASTRUMLANG_API EnumClassMemberSpecificationContext
		    : public antlr4::ParserRuleContext {
		   public:
			EnumClassMemberSpecificationContext(antlr4::ParserRuleContext* parent,
			                                    size_t invokingState);
			virtual size_t getRuleIndex() const override;
			antlr4::tree::TerminalNode* Semi();
			std::vector<StructMemberDeclarationContext*> structMemberDeclaration();
		...
		class ASTRUMLANG_API UnionMemberSpecificationContext : public antlr4::ParserRuleContext {
		   public:
			UnionMemberSpecificationContext(antlr4::ParserRuleContext* parent,
			                                size_t invokingState);
			virtual size_t getRuleIndex() const override;
			antlr4::tree::TerminalNode* Semi();
			std::vector<EnumMemberDeclarationContext*> enumMemberDeclaration();
		...
		class ASTRUMLANG_API ExtensionMemberSpecificationContext
		    : public antlr4::ParserRuleContext {
		   public:
			ExtensionMemberSpecificationContext(antlr4::ParserRuleContext* parent,
			                                    size_t invokingState);
			virtual size_t getRuleIndex() const override;
		...
		class ASTRUMLANG_API ExtensionMemberDeclarationContext : public antlr4::ParserRuleContext {
		   public:
			ExtensionMemberDeclarationContext(antlr4::ParserRuleContext* parent,
			                                  size_t invokingState);
			virtual size_t getRuleIndex() const override;
			FunctionDefinitionContext* functionDefinition();
			AttributeSpecifierSeqContext* attributeSpecifierSeq();
		...
		class ASTRUMLANG_API ExternFunctionDeclarationContext : public antlr4::ParserRuleContext {
		   public:
			ExternFunctionDeclarationContext(antlr4::ParserRuleContext* parent,
			                                 size_t invokingState);
			virtual size_t getRuleIndex() const override;
			antlr4::tree::TerminalNode* Extern();
			antlr4::tree::TerminalNode* Identifier();
		...
		class ASTRUMLANG_API FunctionTemplateDeclarationContext : public antlr4::ParserRuleContext {
		   public:
			FunctionTemplateDeclarationContext(antlr4::ParserRuleContext* parent,
			                                   size_t invokingState);
			virtual size_t getRuleIndex() const override;
			antlr4::tree::TerminalNode* Identifier();
			antlr4::tree::TerminalNode* Colon();
		...
		class ASTRUMLANG_API AbstractMethodDeclarationContext : public antlr4::ParserRuleContext {
		   public:
			AbstractMethodDeclarationContext(antlr4::ParserRuleContext* parent,
			                                 size_t invokingState);
			virtual size_t getRuleIndex() const override;
			antlr4::tree::TerminalNode* Abstract();
			antlr4::tree::TerminalNode* Colon();
		...
		class ASTRUMLANG_API InterfaceMethodDeclarationContext : public antlr4::ParserRuleContext {
		   public:
			InterfaceMethodDeclarationContext(antlr4::ParserRuleContext* parent,
			                                  size_t invokingState);
			virtual size_t getRuleIndex() const override;
			antlr4::tree::TerminalNode* Colon();
			FunctionParamsContext* functionParams();
		...
		class ASTRUMLANG_API MemberInitializationListContext : public antlr4::ParserRuleContext {
		   public:
			MemberInitializationListContext(antlr4::ParserRuleContext* parent,
			                                size_t invokingState);
			virtual size_t getRuleIndex() const override;
		...
		class ASTRUMLANG_API DelegatingConstructorBodyContext : public antlr4::ParserRuleContext {
		   public:
			DelegatingConstructorBodyContext(antlr4::ParserRuleContext* parent,
			                                 size_t invokingState);
			virtual size_t getRuleIndex() const override;
			antlr4::tree::TerminalNode* AssignArrow();
			antlr4::tree::TerminalNode* EqualArrow();
		...
		class ASTRUMLANG_API DelegatingConstructorStatementContext
		    : public antlr4::ParserRuleContext {
		   public:
			DelegatingConstructorStatementContext(antlr4::ParserRuleContext* parent,
			                                      size_t invokingState);
			virtual size_t getRuleIndex() const override;
			antlr4::tree::TerminalNode* LeftParen();
			antlr4::tree::TerminalNode* RightParen();
		...
		class ASTRUMLANG_API MemberInitializationStatementContext
		    : public antlr4::ParserRuleContext {
		   public:
			MemberInitializationStatementContext(antlr4::ParserRuleContext* parent,
			                                     size_t invokingState);
			virtual size_t getRuleIndex() const override;
			antlr4::tree::TerminalNode* Identifier();
			antlr4::tree::TerminalNode* Assign();
		...
		class ASTRUMLANG_API TemplateParamDeclarationContext : public antlr4::ParserRuleContext {
		   public:
			TemplateParamDeclarationContext(antlr4::ParserRuleContext* parent,
			                                size_t invokingState);
			virtual size_t getRuleIndex() const override;
			antlr4::tree::TerminalNode* Identifier();
			TemplateParamsContext* templateParams();
		...
		class ASTRUMLANG_API InterpolatedStringLiteralContext : public antlr4::ParserRuleContext {
		   public:
			InterpolatedStringLiteralContext(antlr4::ParserRuleContext* parent,
			                                 size_t invokingState);
			virtual size_t getRuleIndex() const override;
		...
		class ASTRUMLANG_API InterpolatedRegularStringLiteralContext
		    : public antlr4::ParserRuleContext {
		   public:
			InterpolatedRegularStringLiteralContext(antlr4::ParserRuleContext* parent,
			                                        size_t invokingState);
			virtual size_t getRuleIndex() const override;
		...
		class ASTRUMLANG_API InterpolatedRegularStringPartContext
		    : public antlr4::ParserRuleContext {
		   public:
			InterpolatedRegularStringPartContext(antlr4::ParserRuleContext* parent,
			                                     size_t invokingState);
			virtual size_t getRuleIndex() const override;
		...
		class ASTRUMLANG_API InterpolatedVerbatiumStringLiteralContext
		    : public antlr4::ParserRuleContext {
		   public:
			InterpolatedVerbatiumStringLiteralContext(antlr4::ParserRuleContext* parent,
			                                          size_t invokingState);
			virtual size_t getRuleIndex() const override;
		...
		class ASTRUMLANG_API InterpolatedVerbatiumStringPartContext
		    : public antlr4::ParserRuleContext {
		   public:
			InterpolatedVerbatiumStringPartContext(antlr4::ParserRuleContext* parent,
			                                       size_t invokingState);
			virtual size_t getRuleIndex() const override;
			InterpolatedExpressionContext* interpolatedExpression();
			antlr4::tree::TerminalNode* DOUBLE_CURLY_INSIDE();
		...
		class ASTRUMLANG_API InterpolatedMultilineStringLiteralContext
		    : public antlr4::ParserRuleContext {
		   public:
			InterpolatedMultilineStringLiteralContext(antlr4::ParserRuleContext* parent,
			                                          size_t invokingState);
			virtual size_t getRuleIndex() const override;
		...
		class ASTRUMLANG_API InterpolatedMultilineStringPartContext
		    : public antlr4::ParserRuleContext {
		   public:
			InterpolatedMultilineStringPartContext(antlr4::ParserRuleContext* parent,
			                                       size_t invokingState);
			virtual size_t getRuleIndex() const override;
			InterpolatedExpressionContext* interpolatedExpression();
			antlr4::tree::TerminalNode* DOUBLE_CURLY_INSIDE();
		...
		bool multiplicativeExpressionSempred(MultiplicativeExpressionContext* _localctx,
		...
		bool exclusiveOrExpressionSempred(ExclusiveOrExpressionContext* _localctx,
		                                  size_t predicateIndex);
		bool inclusiveOrExpressionSempred(InclusiveOrExpressionContext* _localctx,
		                                  size_t predicateIndex);
		bool postfixExpressionSempred(PostfixExpressionContext* _localctx, size_t predicateIndex);
		bool nestedNameSpecifierSempred(NestedNameSpecifierContext* _localctx,
		                                size_t predicateIndex);
