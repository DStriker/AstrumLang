	...
	class ASTRUMLANG_API AstrumParserBaseVisitor : public AstrumParserVisitor {
	   public:
		...
		virtual std::any visitPackageDeclaration(
		    AstrumParser::PackageDeclarationContext* ctx) override {
			return visitChildren(ctx);
		}
		...
		virtual std::any visitNestedPackageName(
		    AstrumParser::NestedPackageNameContext* ctx) override {
			return visitChildren(ctx);
		}
		...
		virtual std::any visitImportDeclaration(
		    AstrumParser::ImportDeclarationContext* ctx) override {
			return visitChildren(ctx);
		}
		...
		virtual std::any visitSymbolSpecifierSeq(
		    AstrumParser::SymbolSpecifierSeqContext* ctx) override {
			return visitChildren(ctx);
		}

		virtual std::any visitVersionDefinition(
		    AstrumParser::VersionDefinitionContext* ctx) override {
			return visitChildren(ctx);
		}
		...
		virtual std::any visitBlockDeclaration(
		    AstrumParser::BlockDeclarationContext* ctx) override {
			return visitChildren(ctx);
		}
		...
		virtual std::any visitAssertDeclaration(
		    AstrumParser::AssertDeclarationContext* ctx) override {
			return visitChildren(ctx);
		}

		virtual std::any visitAssumeDeclaration(
		    AstrumParser::AssumeDeclarationContext* ctx) override {
			return visitChildren(ctx);
		}

		virtual std::any visitUnitTestDeclaration(
		    AstrumParser::UnitTestDeclarationContext* ctx) override {
			return visitChildren(ctx);
		}
		...
		virtual std::any visitVersionIfDeclaration(
		    AstrumParser::VersionIfDeclarationContext* ctx) override {
			return visitChildren(ctx);
		}
		...
		virtual std::any visitDeclSpecifierSeq(
		    AstrumParser::DeclSpecifierSeqContext* ctx) override {
			return visitChildren(ctx);
		}
		...
		virtual std::any visitSimpleDeclaration(
		    AstrumParser::SimpleDeclarationContext* ctx) override {
			return visitChildren(ctx);
		}

		virtual std::any visitBitFieldDeclaration(
		    AstrumParser::BitFieldDeclarationContext* ctx) override {
			return visitChildren(ctx);
		}
		...
		virtual std::any visitMemberRefDeclaration(
		    AstrumParser::MemberRefDeclarationContext* ctx) override {
			return visitChildren(ctx);
		}
		...
		virtual std::any visitMultiDeclaration(
		    AstrumParser::MultiDeclarationContext* ctx) override {
			return visitChildren(ctx);
		}

		virtual std::any visitConstantDeclaration(
		    AstrumParser::ConstantDeclarationContext* ctx) override {
			return visitChildren(ctx);
		}
		...
		virtual std::any visitAliasDeclaration(
		    AstrumParser::AliasDeclarationContext* ctx) override {
			return visitChildren(ctx);
		}
		...
		virtual std::any visitProtectedInternal(
		    AstrumParser::ProtectedInternalContext* ctx) override {
			return visitChildren(ctx);
		}
		...
		virtual std::any visitLabeledStatement(
		    AstrumParser::LabeledStatementContext* ctx) override {
			return visitChildren(ctx);
		}

		virtual std::any visitDeclarationStatement(
		    AstrumParser::DeclarationStatementContext* ctx) override {
			return visitChildren(ctx);
		}

		virtual std::any visitExpressionStatement(
		    AstrumParser::ExpressionStatementContext* ctx) override {
			return visitChildren(ctx);
		}

		virtual std::any visitCompoundStatement(
		    AstrumParser::CompoundStatementContext* ctx) override {
			return visitChildren(ctx);
		}

		virtual std::any visitSelectionStatement(
		    AstrumParser::SelectionStatementContext* ctx) override {
			return visitChildren(ctx);
		}
		...
		virtual std::any visitInlineCppStatement(
		    AstrumParser::InlineCppStatementContext* ctx) override {
			return visitChildren(ctx);
		}

		virtual std::any visitIterationStatement(
		    AstrumParser::IterationStatementContext* ctx) override {
			return visitChildren(ctx);
		}
		...
		virtual std::any visitDoWhileCondition(
		    AstrumParser::DoWhileConditionContext* ctx) override {
			return visitChildren(ctx);
		}

		virtual std::any visitForInitStatement(
		    AstrumParser::ForInitStatementContext* ctx) override {
			return visitChildren(ctx);
		}

		virtual std::any visitForRangeDeclaration(
		    AstrumParser::ForRangeDeclarationContext* ctx) override {
			return visitChildren(ctx);
		}

		virtual std::any visitForRangeInitializer(
		    AstrumParser::ForRangeInitializerContext* ctx) override {
			return visitChildren(ctx);
		}
		...
		virtual std::any visitExceptionHandler(
		    AstrumParser::ExceptionHandlerContext* ctx) override {
			return visitChildren(ctx);
		}

		virtual std::any visitExceptionDeclaration(
		    AstrumParser::ExceptionDeclarationContext* ctx) override {
			return visitChildren(ctx);
		}
		...
		virtual std::any visitRangeExpressionStart(
		    AstrumParser::RangeExpressionStartContext* ctx) override {
			return visitChildren(ctx);
		}

		virtual std::any visitRangeExpressionEnd(
		    AstrumParser::RangeExpressionEndContext* ctx) override {
			return visitChildren(ctx);
		}

		virtual std::any visitSwitchExpression(
		    AstrumParser::SwitchExpressionContext* ctx) override {
			return visitChildren(ctx);
		}
		...
		virtual std::any visitAdditiveExpression(
		    AstrumParser::AdditiveExpressionContext* ctx) override {
			return visitChildren(ctx);
		}
		...
		virtual std::any visitRelationalExpression(
		    AstrumParser::RelationalExpressionContext* ctx) override {
			return visitChildren(ctx);
		}

		virtual std::any visitEqualityExpression(
		    AstrumParser::EqualityExpressionContext* ctx) override {
			return visitChildren(ctx);
		}
		...
		virtual std::any visitLogicalAndExpression(
		    AstrumParser::LogicalAndExpressionContext* ctx) override {
			return visitChildren(ctx);
		}

		virtual std::any visitLogicalOrExpression(
		    AstrumParser::LogicalOrExpressionContext* ctx) override {
			return visitChildren(ctx);
		}
		...
		virtual std::any visitNullCoalescingBranch(
		    AstrumParser::NullCoalescingBranchContext* ctx) override {
			return visitChildren(ctx);
		}
		...
		virtual std::any visitConstantExpression(
		    AstrumParser::ConstantExpressionContext* ctx) override {
			return visitChildren(ctx);
		}

		virtual std::any visitAssignmentExpression(
		    AstrumParser::AssignmentExpressionContext* ctx) override {
			return visitChildren(ctx);
		}

		virtual std::any visitInitializerClause(
		    AstrumParser::InitializerClauseContext* ctx) override {
			return visitChildren(ctx);
		}
		...
		virtual std::any visitCollectionExpression(
		    AstrumParser::CollectionExpressionContext* ctx) override {
			return visitChildren(ctx);
		}
		...
		virtual std::any visitExpressionListPart(
		    AstrumParser::ExpressionListPartContext* ctx) override {
			return visitChildren(ctx);
		}
		...
		virtual std::any visitUnaryExpressionTail(
		    AstrumParser::UnaryExpressionTailContext* ctx) override {
			return visitChildren(ctx);
		}
		...
		virtual std::any visitStackallocExpression(
		    AstrumParser::StackallocExpressionContext* ctx) override {
			return visitChildren(ctx);
		}

		virtual std::any visitMemorySpaceSetter(
		    AstrumParser::MemorySpaceSetterContext* ctx) override {
			return visitChildren(ctx);
		}
		...
		virtual std::any visitPostfixExpression(
		    AstrumParser::PostfixExpressionContext* ctx) override {
			return visitChildren(ctx);
		}
		...
		virtual std::any visitPrimaryExpression(
		    AstrumParser::PrimaryExpressionContext* ctx) override {
			return visitChildren(ctx);
		}
		...
		virtual std::any visitFoldLeftExpression(
		    AstrumParser::FoldLeftExpressionContext* ctx) override {
			return visitChildren(ctx);
		}

		virtual std::any visitFoldRightExpression(
		    AstrumParser::FoldRightExpressionContext* ctx) override {
			return visitChildren(ctx);
		}

		virtual std::any visitDeclvalExpression(
		    AstrumParser::DeclvalExpressionContext* ctx) override {
			return visitChildren(ctx);
		}

		virtual std::any visitLambdaExpression(
		    AstrumParser::LambdaExpressionContext* ctx) override {
			return visitChildren(ctx);
		}

		virtual std::any visitLambdaCaptureList(
		    AstrumParser::LambdaCaptureListContext* ctx) override {
			return visitChildren(ctx);
		}

		virtual std::any visitLambdaCaptureClause(
		    AstrumParser::LambdaCaptureClauseContext* ctx) override {
			return visitChildren(ctx);
		}
		...
		virtual std::any visitLambdaDeclarator(
		    AstrumParser::LambdaDeclaratorContext* ctx) override {
			return visitChildren(ctx);
		}
		...
		virtual std::any visitPointerOperatorSeq(
		    AstrumParser::PointerOperatorSeqContext* ctx) override {
			return visitChildren(ctx);
		}

		virtual std::any visitTypeSpecifierSeq(
		    AstrumParser::TypeSpecifierSeqContext* ctx) override {
			return visitChildren(ctx);
		}
		...
		virtual std::any visitTypeNameSpecifier(
		    AstrumParser::TypeNameSpecifierContext* ctx) override {
			return visitChildren(ctx);
		}
		...
		virtual std::any visitDecltypeSpecifier(
		    AstrumParser::DecltypeSpecifierContext* ctx) override {
			return visitChildren(ctx);
		}
		...
		virtual std::any visitSimpleTypeSpecifier(
		    AstrumParser::SimpleTypeSpecifierContext* ctx) override {
			return visitChildren(ctx);
		}
		...
		virtual std::any visitNestedNameSpecifier(
		    AstrumParser::NestedNameSpecifierContext* ctx) override {
			return visitChildren(ctx);
		}
		...
		virtual std::any visitSimpleTemplateId(
		    AstrumParser::SimpleTemplateIdContext* ctx) override {
			return visitChildren(ctx);
		}

		virtual std::any visitOperatorTemplateId(
		    AstrumParser::OperatorTemplateIdContext* ctx) override {
			return visitChildren(ctx);
		}
		...
		virtual std::any visitStructDefinition(
		    AstrumParser::StructDefinitionContext* ctx) override {
			return visitChildren(ctx);
		}
		...
		virtual std::any visitInterfaceDefinition(
		    AstrumParser::InterfaceDefinitionContext* ctx) override {
			return visitChildren(ctx);
		}
		...
		virtual std::any visitEnumeratorDefinition(
		    AstrumParser::EnumeratorDefinitionContext* ctx) override {
			return visitChildren(ctx);
		}
		...
		virtual std::any visitEnumClassDefinition(
		    AstrumParser::EnumClassDefinitionContext* ctx) override {
			return visitChildren(ctx);
		}
		...
		virtual std::any visitExtensionDefinition(
		    AstrumParser::ExtensionDefinitionContext* ctx) override {
			return visitChildren(ctx);
		}
		...
		virtual std::any visitBaseSpecifierList(
		    AstrumParser::BaseSpecifierListContext* ctx) override {
			return visitChildren(ctx);
		}
		...
		virtual std::any visitAbstractProperty(
		    AstrumParser::AbstractPropertyContext* ctx) override {
			return visitChildren(ctx);
		}

		virtual std::any visitInterfaceProperty(
		    AstrumParser::InterfacePropertyContext* ctx) override {
			return visitChildren(ctx);
		}
		...
		virtual std::any visitFunctionDefinition(
		    AstrumParser::FunctionDefinitionContext* ctx) override {
			return visitChildren(ctx);
		}
		...
		virtual std::any visitFunctionSpecifier(
		    AstrumParser::FunctionSpecifierContext* ctx) override {
			return visitChildren(ctx);
		}
		...
		virtual std::any visitParamDeclaration(
		    AstrumParser::ParamDeclarationContext* ctx) override {
			return visitChildren(ctx);
		}

		virtual std::any visitParamSpecification(
		    AstrumParser::ParamSpecificationContext* ctx) override {
			return visitChildren(ctx);
		}
		...
		virtual std::any visitShortFunctionBody(
		    AstrumParser::ShortFunctionBodyContext* ctx) override {
			return visitChildren(ctx);
		}
		...
		virtual std::any visitFriendDeclaration(
		    AstrumParser::FriendDeclarationContext* ctx) override {
			return visitChildren(ctx);
		}
		...
		virtual std::any visitOperatorFunctionId(
		    AstrumParser::OperatorFunctionIdContext* ctx) override {
			return visitChildren(ctx);
		}
		...
		virtual std::any visitStaticConstructor(
		    AstrumParser::StaticConstructorContext* ctx) override {
			return visitChildren(ctx);
		}
		...
		virtual std::any visitStaticDestructor(
		    AstrumParser::StaticDestructorContext* ctx) override {
			return visitChildren(ctx);
		}

		virtual std::any visitConversionFunction(
		    AstrumParser::ConversionFunctionContext* ctx) override {
			return visitChildren(ctx);
		}

		virtual std::any visitConversionFunctionId(
		    AstrumParser::ConversionFunctionIdContext* ctx) override {
			return visitChildren(ctx);
		}
		...
		virtual std::any visitInterfaceIndexer(
		    AstrumParser::InterfaceIndexerContext* ctx) override {
			return visitChildren(ctx);
		}
		...
		virtual std::any visitTemplateTypename(
		    AstrumParser::TemplateTypenameContext* ctx) override {
			return visitChildren(ctx);
		}

		virtual std::any visitTemplateArgumentList(
		    AstrumParser::TemplateArgumentListContext* ctx) override {
			return visitChildren(ctx);
		}

		virtual std::any visitTemplateArgument(
		    AstrumParser::TemplateArgumentContext* ctx) override {
			return visitChildren(ctx);
		}

		virtual std::any visitConstraintClause(
		    AstrumParser::ConstraintClauseContext* ctx) override {
			return visitChildren(ctx);
		}
		...
		virtual std::any visitAttributeSpecifier(
		    AstrumParser::AttributeSpecifierContext* ctx) override {
			return visitChildren(ctx);
		}
		...
		virtual std::any visitAssignmentOperator(
		    AstrumParser::AssignmentOperatorContext* ctx) override {
			return visitChildren(ctx);
		}
		...
		virtual std::any visitUnaryPrefixOperator(
		    AstrumParser::UnaryPrefixOperatorContext* ctx) override {
			return visitChildren(ctx);
		}

		virtual std::any visitUnaryCustomOperator(
		    AstrumParser::UnaryCustomOperatorContext* ctx) override {
			return visitChildren(ctx);
		}

		virtual std::any visitRefCaptureOperator(
		    AstrumParser::RefCaptureOperatorContext* ctx) override {
			return visitChildren(ctx);
		}

		virtual std::any visitUnaryPostfixOperator(
		    AstrumParser::UnaryPostfixOperatorContext* ctx) override {
			return visitChildren(ctx);
		}
