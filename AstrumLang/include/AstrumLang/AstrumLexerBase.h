...
namespace AstrumLang {
	class ASTRUMLANG_API AstrumLexerBase : public antlr4::Lexer {
	   public:
		explicit AstrumLexerBase(antlr4::CharStream* input) : antlr4::Lexer(input) {}
	   ...
	   protected:
		...
		void OpenBraceInside() { curlyLevels.push(1); }

		void OnCloseBraceInside() { curlyLevels.pop(); }

		bool IsRegularCharInside() { return currentInterpolatedType == 0; }

		bool IsVerbatiumCharInside() { return currentInterpolatedType == 1; }

		bool IsMultilineStringInside() { return currentInterpolatedType == 2; }
